...
--- @field public NAME string "UTF8String4"
--- @field public length_byte_length number 4 (This is the number of bytes the length description takes)
...
local UTF8String4 = {}
setmetatable(UTF8String4, StringABC.new_mt({NAME = "UTF8String4", ID = 0x0E}, 4))
