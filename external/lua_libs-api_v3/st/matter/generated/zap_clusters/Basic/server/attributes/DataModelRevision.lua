...
function DataModelRevision:new_value(...)
...
function DataModelRevision:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function DataModelRevision:subscribe(device, endpoint_id)
...
function DataModelRevision:set_parent_cluster(cluster)
...
function DataModelRevision:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function DataModelRevision:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(DataModelRevision, {__call = DataModelRevision.new_value})
