...
--- @field public NAME string "HardwareVersion" the name of this attribute
--- @field public data_type st.matter.data_types.Uint16 the data type of this attribute

local HardwareVersion = {
  ID = 0x0007,
...
function HardwareVersion:new_value(...)
...
function HardwareVersion:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function HardwareVersion:subscribe(device, endpoint_id)
...
function HardwareVersion:set_parent_cluster(cluster)
...
function HardwareVersion:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function HardwareVersion:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(HardwareVersion, {__call = HardwareVersion.new_value})
