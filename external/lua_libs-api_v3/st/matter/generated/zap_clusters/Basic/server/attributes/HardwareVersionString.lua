...
function HardwareVersionString:new_value(...)
...
function HardwareVersionString:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function HardwareVersionString:subscribe(device, endpoint_id)
...
function HardwareVersionString:set_parent_cluster(cluster)
...
function HardwareVersionString:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function HardwareVersionString:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(HardwareVersionString, {__call = HardwareVersionString.new_value})
