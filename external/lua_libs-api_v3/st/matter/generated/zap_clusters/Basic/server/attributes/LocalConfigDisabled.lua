...
function LocalConfigDisabled:new_value(...)
...
function LocalConfigDisabled:read(device, endpoint_id)
...
function LocalConfigDisabled:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LocalConfigDisabled:subscribe(device, endpoint_id)
...
function LocalConfigDisabled:set_parent_cluster(cluster)
...
function LocalConfigDisabled:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LocalConfigDisabled:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(LocalConfigDisabled, {__call = LocalConfigDisabled.new_value})
