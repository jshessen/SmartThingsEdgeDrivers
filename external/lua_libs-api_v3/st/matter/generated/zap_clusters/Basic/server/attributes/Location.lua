...
--- @field public NAME string "Location" the name of this attribute
...
function Location:read(device, endpoint_id)
...
function Location:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function Location:subscribe(device, endpoint_id)
...
function Location:set_parent_cluster(cluster)
...
function Location:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Location:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(Location, {__call = Location.new_value})
return Location
