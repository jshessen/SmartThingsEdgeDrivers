...
--- @field public NAME string "ManufacturingDate" the name of this attribute
--- @field public data_type st.matter.data_types.UTF8String1 the data type of this attribute

local ManufacturingDate = {
  ID = 0x000B,
...
function ManufacturingDate:new_value(...)
...
function ManufacturingDate:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ManufacturingDate:subscribe(device, endpoint_id)
...
function ManufacturingDate:set_parent_cluster(cluster)
...
function ManufacturingDate:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ManufacturingDate:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(ManufacturingDate, {__call = ManufacturingDate.new_value})
