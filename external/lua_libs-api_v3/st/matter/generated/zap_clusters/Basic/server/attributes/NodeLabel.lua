...
--- @field public NAME string "NodeLabel" the name of this attribute
...
function NodeLabel:read(device, endpoint_id)
...
function NodeLabel:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function NodeLabel:subscribe(device, endpoint_id)
...
function NodeLabel:set_parent_cluster(cluster)
...
function NodeLabel:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NodeLabel:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(NodeLabel, {__call = NodeLabel.new_value})
return NodeLabel
