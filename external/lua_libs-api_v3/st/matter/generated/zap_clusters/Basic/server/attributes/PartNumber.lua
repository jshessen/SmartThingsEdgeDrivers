...
--- @field public NAME string "PartNumber" the name of this attribute
...
function PartNumber:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PartNumber:subscribe(device, endpoint_id)
...
function PartNumber:set_parent_cluster(cluster)
...
function PartNumber:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PartNumber:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(PartNumber, {__call = PartNumber.new_value})
return PartNumber
