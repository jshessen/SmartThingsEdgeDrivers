...
--- @field public NAME string "ProductID" the name of this attribute
...
function ProductID:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ProductID:subscribe(device, endpoint_id)
...
function ProductID:set_parent_cluster(cluster)
...
function ProductID:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ProductID:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(ProductID, {__call = ProductID.new_value})
return ProductID
