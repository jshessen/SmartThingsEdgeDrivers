...
function ProductLabel:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ProductLabel:subscribe(device, endpoint_id)
...
function ProductLabel:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ProductLabel:deserialize(tlv_buf)
