...
--- @field public NAME string "ProductName" the name of this attribute
...
function ProductName:new_value(...)
...
function ProductName:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ProductName:subscribe(device, endpoint_id)
...
function ProductName:set_parent_cluster(cluster)
...
function ProductName:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ProductName:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(ProductName, {__call = ProductName.new_value})
return ProductName
