...
--- @field public data_type st.matter.data_types.UTF8String2 the data type of this attribute

local ProductURL = {
  ID = 0x000D,
  NAME = "ProductURL",
  base_type = data_types.UTF8String2,
}
...
--- @return st.matter.data_types.UTF8String2
...
function ProductURL:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ProductURL:subscribe(device, endpoint_id)
...
function ProductURL:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ProductURL:deserialize(tlv_buf)
