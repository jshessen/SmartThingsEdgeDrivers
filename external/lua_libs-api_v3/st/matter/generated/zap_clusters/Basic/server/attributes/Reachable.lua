...
--- @field public NAME string "Reachable" the name of this attribute
...
function Reachable:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Reachable:subscribe(device, endpoint_id)
...
function Reachable:set_parent_cluster(cluster)
...
function Reachable:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Reachable:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(Reachable, {__call = Reachable.new_value})
return Reachable
