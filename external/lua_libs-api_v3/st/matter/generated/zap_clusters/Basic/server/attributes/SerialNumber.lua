...
function SerialNumber:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SerialNumber:subscribe(device, endpoint_id)
...
function SerialNumber:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SerialNumber:deserialize(tlv_buf)
