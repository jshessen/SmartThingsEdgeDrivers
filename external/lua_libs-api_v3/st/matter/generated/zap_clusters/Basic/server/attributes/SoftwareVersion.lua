...
--- @field public NAME string "SoftwareVersion" the name of this attribute
...
function SoftwareVersion:new_value(...)
...
function SoftwareVersion:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SoftwareVersion:subscribe(device, endpoint_id)
...
function SoftwareVersion:set_parent_cluster(cluster)
...
function SoftwareVersion:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SoftwareVersion:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(SoftwareVersion, {__call = SoftwareVersion.new_value})
