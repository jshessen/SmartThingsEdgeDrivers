...
function SoftwareVersionString:new_value(...)
...
function SoftwareVersionString:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SoftwareVersionString:subscribe(device, endpoint_id)
...
function SoftwareVersionString:set_parent_cluster(cluster)
...
function SoftwareVersionString:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SoftwareVersionString:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(SoftwareVersionString, {__call = SoftwareVersionString.new_value})
