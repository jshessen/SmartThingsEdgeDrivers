...
--- @field public NAME string "UniqueID" the name of this attribute
...
function UniqueID:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function UniqueID:subscribe(device, endpoint_id)
...
function UniqueID:set_parent_cluster(cluster)
...
function UniqueID:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function UniqueID:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(UniqueID, {__call = UniqueID.new_value})
return UniqueID
