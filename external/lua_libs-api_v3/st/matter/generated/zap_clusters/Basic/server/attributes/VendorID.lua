...
--- @field public NAME string "VendorID" the name of this attribute
...
function VendorID:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function VendorID:subscribe(device, endpoint_id)
...
function VendorID:set_parent_cluster(cluster)
...
function VendorID:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function VendorID:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(VendorID, {__call = VendorID.new_value})
return VendorID
