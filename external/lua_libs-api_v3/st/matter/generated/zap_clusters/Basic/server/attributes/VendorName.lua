...
--- @field public NAME string "VendorName" the name of this attribute
...
function VendorName:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function VendorName:subscribe(device, endpoint_id)
...
function VendorName:set_parent_cluster(cluster)
...
function VendorName:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function VendorName:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(VendorName, {__call = VendorName.new_value})
return VendorName
