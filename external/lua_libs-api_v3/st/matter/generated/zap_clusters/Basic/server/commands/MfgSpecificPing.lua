...
-----------------------------------------------------------
-- Basic command MfgSpecificPing
-----------------------------------------------------------

--- @class st.matter.clusters.Basic.MfgSpecificPing
--- @alias MfgSpecificPing
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "MfgSpecificPing" the name of this command
local MfgSpecificPing = {}

MfgSpecificPing.NAME = "MfgSpecificPing"
MfgSpecificPing.ID = 0x0000
MfgSpecificPing.field_defs = {
}
...
function MfgSpecificPing:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self MfgSpecificPing the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function MfgSpecificPing:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = MfgSpecificPing,
    __tostring = MfgSpecificPing.pretty_print
  })
...
function MfgSpecificPing:set_parent_cluster(cluster)
...
function MfgSpecificPing:augment_type(base_type_obj)
  local elems = {}
...
function MfgSpecificPing:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(MfgSpecificPing, {__call = MfgSpecificPing.init})
