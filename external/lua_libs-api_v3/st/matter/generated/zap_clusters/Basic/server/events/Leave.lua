...
--- @field public NAME string "Leave" the name of this event
...
function Leave:augment_type(base_type_obj)
  local elems = {}
...
function Leave:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function Leave:subscribe(device, endpoint_id)
...
function Leave:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "LeaveEventData", ID = 0x15}))
...
function Leave:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function Leave:set_parent_cluster(cluster)
