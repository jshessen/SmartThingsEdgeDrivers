...
--- @alias ReachableChanged
---
--- @field public ID number 0x0003 the ID of this event
--- @field public NAME string "ReachableChanged" the name of this event
--- @field public reachable_new_value data_types.Boolean
local ReachableChanged = {
  ID = 0x0003,
  NAME = "ReachableChanged",
  base_type = data_types.Structure,
}

ReachableChanged.field_defs = {
  {
    data_type = data_types.Boolean,
    field_id = 0,
    is_array = false,
    name = "reachable_new_value",
    is_nullable = false,
    is_optional = false,
  },
}
...
function ReachableChanged:augment_type(base_type_obj)
  local elems = {}
...
function ReachableChanged:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function ReachableChanged:subscribe(device, endpoint_id)
...
function ReachableChanged:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "ReachableChangedEventData", ID = 0x15}))
...
function ReachableChanged:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function ReachableChanged:set_parent_cluster(cluster)
