...
--- @field public NAME string "StartUp" the name of this event
--- @field public software_version data_types.Uint32
local StartUp = {
  ID = 0x0000,
  NAME = "StartUp",
...
function StartUp:augment_type(base_type_obj)
  local elems = {}
...
function StartUp:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function StartUp:subscribe(device, endpoint_id)
...
function StartUp:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "StartUpEventData", ID = 0x15}))
...
function StartUp:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function StartUp:set_parent_cluster(cluster)
