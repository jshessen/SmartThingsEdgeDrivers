...
--- @alias CapabilityMinimaStruct
--- @class st.matter.clusters.Basic.types.CapabilityMinimaStruct: st.matter.data_types.Structure
---
--- @field public case_sessions_per_fabric st.matter.data_types.Uint16
--- @field public subscriptions_per_fabric st.matter.data_types.Uint16
local CapabilityMinimaStruct = {}
local new_mt = StructureABC.new_mt({NAME = "CapabilityMinimaStruct", ID = data_types.name_to_id_map["Structure"]})

CapabilityMinimaStruct.field_defs = {
  {
    data_type = data_types.Uint16,
    field_id = 0,
    name = "case_sessions_per_fabric",
    is_nullable = false,
    is_optional = false,
  },
  {
    data_type = data_types.Uint16,
    field_id = 1,
    name = "subscriptions_per_fabric",
    is_nullable = false,
    is_optional = false,
  },
}

CapabilityMinimaStruct.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
CapabilityMinimaStruct.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = CapabilityMinimaStruct.init
new_mt.__index.serialize = CapabilityMinimaStruct.serialize

CapabilityMinimaStruct.augment_type = function(self, val)
  local elems = {}
...
setmetatable(CapabilityMinimaStruct, new_mt)
