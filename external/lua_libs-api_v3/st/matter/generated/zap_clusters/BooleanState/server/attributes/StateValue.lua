...
--- @class st.matter.clusters.BooleanState.StateValue
--- @alias StateValue
---
--- @field public ID number 0x0000 the ID of this attribute
--- @field public NAME string "StateValue" the name of this attribute
...
function StateValue:read(device, endpoint_id)
...
--- Reporting policy: StateValue => true => suggested
...
--- @param endpoint_id number|nil
--- @return any
function StateValue:subscribe(device, endpoint_id)
...
function StateValue:set_parent_cluster(cluster)
  self._cluster = cluster
  return self
end

--- Builds an StateValue test attribute reponse for the driver integration testing framework
---
...
function StateValue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function StateValue:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(StateValue, {__call = StateValue.new_value})
return StateValue
