...
--- @class st.matter.clusters.BooleanState.StateChange
--- @alias StateChange
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "StateChange" the name of this event
--- @field public state_value data_types.Boolean
local StateChange = {
  ID = 0x0000,
  NAME = "StateChange",
...
function StateChange:augment_type(base_type_obj)
  local elems = {}
...
function StateChange:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function StateChange:subscribe(device, endpoint_id)
...
--- Builds an StateChange test event report reponse to be used by
...
function StateChange:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "StateChangeEventData", ID = 0x15}))
...
function StateChange:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function StateChange:set_parent_cluster(cluster)
