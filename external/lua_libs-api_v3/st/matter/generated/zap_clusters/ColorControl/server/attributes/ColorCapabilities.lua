...
function ColorCapabilities:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorCapabilities:subscribe(device, endpoint_id)
...
function ColorCapabilities:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorCapabilities:deserialize(tlv_buf)
