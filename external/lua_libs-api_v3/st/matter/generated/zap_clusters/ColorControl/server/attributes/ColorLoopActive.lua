...
function ColorLoopActive:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorLoopActive:subscribe(device, endpoint_id)
...
function ColorLoopActive:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorLoopActive:deserialize(tlv_buf)
