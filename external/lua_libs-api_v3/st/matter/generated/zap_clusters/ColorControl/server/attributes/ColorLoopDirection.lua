...
function ColorLoopDirection:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorLoopDirection:subscribe(device, endpoint_id)
...
function ColorLoopDirection:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorLoopDirection:deserialize(tlv_buf)
