...
function ColorLoopStartEnhancedHue:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorLoopStartEnhancedHue:subscribe(device, endpoint_id)
...
function ColorLoopStartEnhancedHue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorLoopStartEnhancedHue:deserialize(tlv_buf)
