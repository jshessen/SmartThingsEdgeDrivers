...
function ColorLoopStoredEnhancedHue:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorLoopStoredEnhancedHue:subscribe(device, endpoint_id)
...
function ColorLoopStoredEnhancedHue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorLoopStoredEnhancedHue:deserialize(tlv_buf)
