...
function ColorLoopTime:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorLoopTime:subscribe(device, endpoint_id)
...
function ColorLoopTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorLoopTime:deserialize(tlv_buf)
