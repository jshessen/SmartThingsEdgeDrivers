...
function ColorMode:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorMode:subscribe(device, endpoint_id)
...
function ColorMode:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorMode:deserialize(tlv_buf)
