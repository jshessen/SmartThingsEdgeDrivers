...
function ColorPointBIntensity:read(device, endpoint_id)
...
function ColorPointBIntensity:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointBIntensity:subscribe(device, endpoint_id)
...
function ColorPointBIntensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointBIntensity:deserialize(tlv_buf)
