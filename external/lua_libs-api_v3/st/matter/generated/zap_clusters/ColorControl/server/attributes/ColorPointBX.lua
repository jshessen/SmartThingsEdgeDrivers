...
function ColorPointBX:read(device, endpoint_id)
...
function ColorPointBX:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointBX:subscribe(device, endpoint_id)
...
function ColorPointBX:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointBX:deserialize(tlv_buf)
