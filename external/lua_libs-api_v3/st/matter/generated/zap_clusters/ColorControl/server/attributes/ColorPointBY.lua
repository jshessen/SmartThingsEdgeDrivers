...
function ColorPointBY:read(device, endpoint_id)
...
function ColorPointBY:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointBY:subscribe(device, endpoint_id)
...
function ColorPointBY:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointBY:deserialize(tlv_buf)
