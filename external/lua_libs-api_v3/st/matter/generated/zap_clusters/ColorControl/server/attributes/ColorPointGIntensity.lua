...
function ColorPointGIntensity:read(device, endpoint_id)
...
function ColorPointGIntensity:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointGIntensity:subscribe(device, endpoint_id)
...
function ColorPointGIntensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointGIntensity:deserialize(tlv_buf)
