...
function ColorPointGX:read(device, endpoint_id)
...
function ColorPointGX:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointGX:subscribe(device, endpoint_id)
...
function ColorPointGX:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointGX:deserialize(tlv_buf)
