...
function ColorPointGY:read(device, endpoint_id)
...
function ColorPointGY:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointGY:subscribe(device, endpoint_id)
...
function ColorPointGY:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointGY:deserialize(tlv_buf)
