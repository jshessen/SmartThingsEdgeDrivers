...
function ColorPointRIntensity:read(device, endpoint_id)
...
function ColorPointRIntensity:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointRIntensity:subscribe(device, endpoint_id)
...
function ColorPointRIntensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointRIntensity:deserialize(tlv_buf)
