...
function ColorPointRX:read(device, endpoint_id)
...
function ColorPointRX:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointRX:subscribe(device, endpoint_id)
...
function ColorPointRX:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointRX:deserialize(tlv_buf)
