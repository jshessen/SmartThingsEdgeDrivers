...
function ColorPointRY:read(device, endpoint_id)
...
function ColorPointRY:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ColorPointRY:subscribe(device, endpoint_id)
...
function ColorPointRY:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorPointRY:deserialize(tlv_buf)
