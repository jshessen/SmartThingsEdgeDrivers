...
function ColorTempPhysicalMaxMireds:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorTempPhysicalMaxMireds:subscribe(device, endpoint_id)
...
function ColorTempPhysicalMaxMireds:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorTempPhysicalMaxMireds:deserialize(tlv_buf)
