...
function ColorTempPhysicalMinMireds:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorTempPhysicalMinMireds:subscribe(device, endpoint_id)
...
function ColorTempPhysicalMinMireds:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorTempPhysicalMinMireds:deserialize(tlv_buf)
