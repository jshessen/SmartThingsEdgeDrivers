...
function ColorTemperatureMireds:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ColorTemperatureMireds:subscribe(device, endpoint_id)
...
function ColorTemperatureMireds:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ColorTemperatureMireds:deserialize(tlv_buf)
