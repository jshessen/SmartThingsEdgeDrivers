...
function CompensationText:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CompensationText:subscribe(device, endpoint_id)
...
function CompensationText:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CompensationText:deserialize(tlv_buf)
