...
function CoupleColorTempToLevelMinMireds:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CoupleColorTempToLevelMinMireds:subscribe(device, endpoint_id)
...
function CoupleColorTempToLevelMinMireds:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CoupleColorTempToLevelMinMireds:deserialize(tlv_buf)
