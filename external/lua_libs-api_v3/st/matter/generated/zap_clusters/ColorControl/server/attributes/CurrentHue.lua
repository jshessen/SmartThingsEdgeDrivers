...
function CurrentHue:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentHue:subscribe(device, endpoint_id)
...
function CurrentHue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentHue:deserialize(tlv_buf)
