...
function CurrentSaturation:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentSaturation:subscribe(device, endpoint_id)
...
function CurrentSaturation:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentSaturation:deserialize(tlv_buf)
