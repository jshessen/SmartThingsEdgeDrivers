...
function CurrentX:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentX:subscribe(device, endpoint_id)
...
function CurrentX:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentX:deserialize(tlv_buf)
