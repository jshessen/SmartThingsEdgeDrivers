...
function CurrentY:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentY:subscribe(device, endpoint_id)
...
function CurrentY:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentY:deserialize(tlv_buf)
