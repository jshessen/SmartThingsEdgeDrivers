...
function DriftCompensation:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function DriftCompensation:subscribe(device, endpoint_id)
...
function DriftCompensation:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function DriftCompensation:deserialize(tlv_buf)
