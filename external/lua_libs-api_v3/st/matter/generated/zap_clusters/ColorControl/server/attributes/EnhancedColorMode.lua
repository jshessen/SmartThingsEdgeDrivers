...
function EnhancedColorMode:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function EnhancedColorMode:subscribe(device, endpoint_id)
...
function EnhancedColorMode:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function EnhancedColorMode:deserialize(tlv_buf)
