...
function EnhancedCurrentHue:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function EnhancedCurrentHue:subscribe(device, endpoint_id)
...
function EnhancedCurrentHue:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function EnhancedCurrentHue:deserialize(tlv_buf)
