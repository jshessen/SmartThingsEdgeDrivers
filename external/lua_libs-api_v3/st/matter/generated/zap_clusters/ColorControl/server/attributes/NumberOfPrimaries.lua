...
function NumberOfPrimaries:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfPrimaries:subscribe(device, endpoint_id)
...
function NumberOfPrimaries:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfPrimaries:deserialize(tlv_buf)
