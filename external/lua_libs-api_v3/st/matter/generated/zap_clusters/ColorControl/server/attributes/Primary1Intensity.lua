...
function Primary1Intensity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary1Intensity:subscribe(device, endpoint_id)
...
function Primary1Intensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary1Intensity:deserialize(tlv_buf)
