...
function Primary1X:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary1X:subscribe(device, endpoint_id)
...
function Primary1X:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary1X:deserialize(tlv_buf)
