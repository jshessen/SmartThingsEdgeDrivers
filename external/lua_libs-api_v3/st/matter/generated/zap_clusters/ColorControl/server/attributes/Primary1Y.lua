...
function Primary1Y:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary1Y:subscribe(device, endpoint_id)
...
function Primary1Y:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary1Y:deserialize(tlv_buf)
