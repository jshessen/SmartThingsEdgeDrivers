...
function Primary2Intensity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary2Intensity:subscribe(device, endpoint_id)
...
function Primary2Intensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary2Intensity:deserialize(tlv_buf)
