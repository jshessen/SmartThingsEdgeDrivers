...
function Primary2X:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary2X:subscribe(device, endpoint_id)
...
function Primary2X:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary2X:deserialize(tlv_buf)
