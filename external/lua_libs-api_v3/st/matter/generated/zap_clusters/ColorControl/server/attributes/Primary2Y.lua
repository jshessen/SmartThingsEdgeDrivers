...
function Primary2Y:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary2Y:subscribe(device, endpoint_id)
...
function Primary2Y:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary2Y:deserialize(tlv_buf)
