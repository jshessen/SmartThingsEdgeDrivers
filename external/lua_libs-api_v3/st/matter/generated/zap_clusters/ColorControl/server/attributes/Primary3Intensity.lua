...
function Primary3Intensity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary3Intensity:subscribe(device, endpoint_id)
...
function Primary3Intensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary3Intensity:deserialize(tlv_buf)
