...
function Primary3X:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary3X:subscribe(device, endpoint_id)
...
function Primary3X:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary3X:deserialize(tlv_buf)
