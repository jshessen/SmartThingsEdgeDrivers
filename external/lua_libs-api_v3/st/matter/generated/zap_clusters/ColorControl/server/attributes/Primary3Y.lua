...
function Primary3Y:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary3Y:subscribe(device, endpoint_id)
...
function Primary3Y:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary3Y:deserialize(tlv_buf)
