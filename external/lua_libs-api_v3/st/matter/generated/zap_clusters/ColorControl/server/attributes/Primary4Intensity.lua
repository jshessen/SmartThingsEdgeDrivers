...
function Primary4Intensity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary4Intensity:subscribe(device, endpoint_id)
...
function Primary4Intensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary4Intensity:deserialize(tlv_buf)
