...
function Primary4Y:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary4Y:subscribe(device, endpoint_id)
...
function Primary4Y:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary4Y:deserialize(tlv_buf)
