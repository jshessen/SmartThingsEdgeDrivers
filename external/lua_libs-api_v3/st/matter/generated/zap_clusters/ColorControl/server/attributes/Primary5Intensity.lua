...
function Primary5Intensity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary5Intensity:subscribe(device, endpoint_id)
...
function Primary5Intensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary5Intensity:deserialize(tlv_buf)
