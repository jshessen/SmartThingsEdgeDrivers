...
function Primary5X:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary5X:subscribe(device, endpoint_id)
...
function Primary5X:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary5X:deserialize(tlv_buf)
