...
function Primary5Y:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary5Y:subscribe(device, endpoint_id)
...
function Primary5Y:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary5Y:deserialize(tlv_buf)
