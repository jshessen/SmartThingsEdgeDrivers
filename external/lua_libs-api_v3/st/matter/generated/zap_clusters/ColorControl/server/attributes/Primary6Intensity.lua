...
function Primary6Intensity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary6Intensity:subscribe(device, endpoint_id)
...
function Primary6Intensity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary6Intensity:deserialize(tlv_buf)
