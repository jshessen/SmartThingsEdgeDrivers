...
function Primary6X:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary6X:subscribe(device, endpoint_id)
...
function Primary6X:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary6X:deserialize(tlv_buf)
