...
function Primary6Y:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Primary6Y:subscribe(device, endpoint_id)
...
function Primary6Y:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Primary6Y:deserialize(tlv_buf)
