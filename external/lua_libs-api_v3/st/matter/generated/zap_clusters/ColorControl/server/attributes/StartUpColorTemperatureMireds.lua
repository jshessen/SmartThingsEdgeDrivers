...
function StartUpColorTemperatureMireds:read(device, endpoint_id)
...
function StartUpColorTemperatureMireds:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function StartUpColorTemperatureMireds:subscribe(device, endpoint_id)
...
function StartUpColorTemperatureMireds:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function StartUpColorTemperatureMireds:deserialize(tlv_buf)
