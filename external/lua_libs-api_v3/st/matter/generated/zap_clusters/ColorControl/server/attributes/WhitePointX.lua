...
function WhitePointX:read(device, endpoint_id)
...
function WhitePointX:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function WhitePointX:subscribe(device, endpoint_id)
...
function WhitePointX:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WhitePointX:deserialize(tlv_buf)
