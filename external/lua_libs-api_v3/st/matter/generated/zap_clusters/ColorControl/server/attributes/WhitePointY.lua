...
function WhitePointY:read(device, endpoint_id)
...
function WhitePointY:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function WhitePointY:subscribe(device, endpoint_id)
...
function WhitePointY:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WhitePointY:deserialize(tlv_buf)
