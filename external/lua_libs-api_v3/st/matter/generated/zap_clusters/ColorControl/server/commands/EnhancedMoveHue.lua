...
EnhancedMoveHue.ID = 0x0041
EnhancedMoveHue.field_defs = {
  {
    name = "move_mode",
    field_id = 0,
    optional = false,
...
function EnhancedMoveHue:build_test_command_response(device, endpoint_id, status)
...
function EnhancedMoveHue:init(device, endpoint_id, move_mode, rate, options_mask, options_override)
  local out = {}
...
function EnhancedMoveHue:augment_type(base_type_obj)
  local elems = {}
...
function EnhancedMoveHue:deserialize(tlv_buf)
