...
---
--- @field public ID number 0x0043 the ID of this command
...
EnhancedMoveToHueAndSaturation.ID = 0x0043
EnhancedMoveToHueAndSaturation.field_defs = {
  {
    name = "enhanced_hue",
    field_id = 0,
    optional = false,
...
function EnhancedMoveToHueAndSaturation:build_test_command_response(device, endpoint_id, status)
...
function EnhancedMoveToHueAndSaturation:init(device, endpoint_id, enhanced_hue, saturation, transition_time, options_mask, options_override)
  local out = {}
...
function EnhancedMoveToHueAndSaturation:augment_type(base_type_obj)
  local elems = {}
...
function EnhancedMoveToHueAndSaturation:deserialize(tlv_buf)
