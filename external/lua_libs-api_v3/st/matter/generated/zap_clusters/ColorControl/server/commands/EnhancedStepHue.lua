...
EnhancedStepHue.ID = 0x0042
EnhancedStepHue.field_defs = {
  {
    name = "step_mode",
    field_id = 0,
    optional = false,
...
function EnhancedStepHue:build_test_command_response(device, endpoint_id, status)
...
function EnhancedStepHue:init(device, endpoint_id, step_mode, step_size, transition_time, options_mask, options_override)
  local out = {}
...
function EnhancedStepHue:augment_type(base_type_obj)
  local elems = {}
...
function EnhancedStepHue:deserialize(tlv_buf)
