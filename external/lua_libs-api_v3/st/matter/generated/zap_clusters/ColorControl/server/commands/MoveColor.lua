...
--- @field public ratex data_types.Int16
--- @field public ratey data_types.Int16
...
function MoveColor:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param ratex st.matter.data_types.Int16
--- @param ratey st.matter.data_types.Int16
...
function MoveColor:init(device, endpoint_id, ratex, ratey, options_mask, options_override)
  local out = {}
  local args = {ratex, ratey, options_mask, options_override}
...
function MoveColor:augment_type(base_type_obj)
  local elems = {}
...
function MoveColor:deserialize(tlv_buf)
