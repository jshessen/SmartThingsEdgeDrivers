...
---
--- @field public ID number 0x004B the ID of this command
...
--- @field public rate data_types.Uint16
...
MoveColorTemperature.ID = 0x004B
MoveColorTemperature.field_defs = {
  {
    name = "move_mode",
    field_id = 0,
    optional = false,
...
function MoveColorTemperature:build_test_command_response(device, endpoint_id, status)
...
--- @param rate st.matter.data_types.Uint16
...
function MoveColorTemperature:init(device, endpoint_id, move_mode, rate, color_temperature_minimum_mireds, color_temperature_maximum_mireds, options_mask, options_override)
  local out = {}
...
function MoveColorTemperature:augment_type(base_type_obj)
  local elems = {}
...
function MoveColorTemperature:deserialize(tlv_buf)
