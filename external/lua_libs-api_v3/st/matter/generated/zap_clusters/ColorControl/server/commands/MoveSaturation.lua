...
local SaturationMoveModeType = require "st.matter.generated.zap_clusters.ColorControl.types.SaturationMoveMode"
...
--- @field public move_mode st.matter.clusters.ColorControl.types.SaturationMoveMode
...
MoveSaturation.ID = 0x0004
MoveSaturation.field_defs = {
  {
    name = "move_mode",
    field_id = 0,
    optional = false,
    nullable = false,
    data_type = SaturationMoveModeType,
  },
  {
    name = "rate",
    field_id = 1,
...
function MoveSaturation:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param move_mode st.matter.clusters.ColorControl.types.SaturationMoveMode
...
function MoveSaturation:init(device, endpoint_id, move_mode, rate, options_mask, options_override)
  local out = {}
...
function MoveSaturation:augment_type(base_type_obj)
  local elems = {}
...
function MoveSaturation:deserialize(tlv_buf)
