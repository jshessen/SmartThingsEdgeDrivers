...
--- @field public colorx data_types.Uint16
--- @field public colory data_types.Uint16
...
MoveToColor.ID = 0x0007
MoveToColor.field_defs = {
  {
    name = "colorx",
    field_id = 0,
    optional = false,
...
function MoveToColor:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param colorx st.matter.data_types.Uint16
--- @param colory st.matter.data_types.Uint16
...
function MoveToColor:init(device, endpoint_id, colorx, colory, transition_time, options_mask, options_override)
  local out = {}
  local args = {colorx, colory, transition_time, options_mask, options_override}
...
function MoveToColor:augment_type(base_type_obj)
  local elems = {}
...
function MoveToColor:deserialize(tlv_buf)
