...
--- @field public color_temperature data_types.Uint16
...
MoveToColorTemperature.ID = 0x000A
MoveToColorTemperature.field_defs = {
  {
...
function MoveToColorTemperature:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param color_temperature st.matter.data_types.Uint16
...
function MoveToColorTemperature:init(device, endpoint_id, color_temperature, transition_time, options_mask, options_override)
  local out = {}
  local args = {color_temperature, transition_time, options_mask, options_override}
...
function MoveToColorTemperature:augment_type(base_type_obj)
  local elems = {}
...
function MoveToColorTemperature:deserialize(tlv_buf)
