...
function MoveToHue:build_test_command_response(device, endpoint_id, status)
...
function MoveToHue:init(device, endpoint_id, hue, direction, transition_time, options_mask, options_override)
  local out = {}
...
function MoveToHue:augment_type(base_type_obj)
  local elems = {}
...
function MoveToHue:deserialize(tlv_buf)
