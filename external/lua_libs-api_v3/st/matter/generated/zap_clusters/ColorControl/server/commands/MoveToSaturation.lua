...
MoveToSaturation.ID = 0x0003
MoveToSaturation.field_defs = {
  {
    name = "saturation",
    field_id = 0,
    optional = false,
...
function MoveToSaturation:build_test_command_response(device, endpoint_id, status)
...
function MoveToSaturation:init(device, endpoint_id, saturation, transition_time, options_mask, options_override)
  local out = {}
...
function MoveToSaturation:augment_type(base_type_obj)
  local elems = {}
...
function MoveToSaturation:deserialize(tlv_buf)
