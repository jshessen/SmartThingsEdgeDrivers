...
--- @field public step_size data_types.Uint8
--- @field public transition_time data_types.Uint8
...
function StepHue:build_test_command_response(device, endpoint_id, status)
...
--- @param step_size st.matter.data_types.Uint8
--- @param transition_time st.matter.data_types.Uint8
...
function StepHue:init(device, endpoint_id, step_mode, step_size, transition_time, options_mask, options_override)
  local out = {}
...
function StepHue:augment_type(base_type_obj)
  local elems = {}
...
function StepHue:deserialize(tlv_buf)
