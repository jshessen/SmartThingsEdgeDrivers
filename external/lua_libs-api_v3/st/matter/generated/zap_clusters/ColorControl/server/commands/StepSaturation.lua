...
local SaturationStepModeType = require "st.matter.generated.zap_clusters.ColorControl.types.SaturationStepMode"
...
--- @field public step_mode st.matter.clusters.ColorControl.types.SaturationStepMode
...
StepSaturation.ID = 0x0005
StepSaturation.field_defs = {
  {
    name = "step_mode",
    field_id = 0,
    optional = false,
    nullable = false,
    data_type = SaturationStepModeType,
  },
  {
    name = "step_size",
    field_id = 1,
...
function StepSaturation:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param step_mode st.matter.clusters.ColorControl.types.SaturationStepMode
...
function StepSaturation:init(device, endpoint_id, step_mode, step_size, transition_time, options_mask, options_override)
  local out = {}
...
function StepSaturation:augment_type(base_type_obj)
  local elems = {}
...
function StepSaturation:deserialize(tlv_buf)
