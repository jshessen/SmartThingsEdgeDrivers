...
--- @alias StopMoveStep
---
--- @field public ID number 0x0047 the ID of this command
...
StopMoveStep.ID = 0x0047
StopMoveStep.field_defs = {
  {
    name = "options_mask",
    field_id = 0,
    optional = false,
...
function StopMoveStep:build_test_command_response(device, endpoint_id, status)
...
function StopMoveStep:init(device, endpoint_id, options_mask, options_override)
  local out = {}
...
function StopMoveStep:augment_type(base_type_obj)
  local elems = {}
...
function StopMoveStep:deserialize(tlv_buf)
