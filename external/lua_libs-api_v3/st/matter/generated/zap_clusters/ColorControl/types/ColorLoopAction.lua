...
local ColorLoopAction = {}
local new_mt = UintABC.new_mt({NAME = "ColorLoopAction", ID = data_types.name_to_id_map["Uint8"]}, 1)
...
ColorLoopAction.augment_type = function(cls, val)
  setmetatable(val, new_mt)
end

setmetatable(ColorLoopAction, new_mt)
