...
local HueStepMode = {}
local new_mt = UintABC.new_mt({NAME = "HueStepMode", ID = data_types.name_to_id_map["Uint8"]}, 1)
...
HueStepMode.augment_type = function(cls, val)
  setmetatable(val, new_mt)
end

setmetatable(HueStepMode, new_mt)
