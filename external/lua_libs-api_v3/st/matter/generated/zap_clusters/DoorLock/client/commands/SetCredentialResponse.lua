...
-----------------------------------------------------------
-- DoorLock command SetCredentialResponse
-----------------------------------------------------------

--- @class st.matter.clusters.DoorLock.SetCredentialResponse
--- @alias SetCredentialResponse
---
--- @field public ID number 0x0023 the ID of this command
--- @field public NAME string "SetCredentialResponse" the name of this command
