...
function AutoRelockTime:read(device, endpoint_id)
...
function AutoRelockTime:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function AutoRelockTime:subscribe(device, endpoint_id)
...
function AutoRelockTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AutoRelockTime:deserialize(tlv_buf)
