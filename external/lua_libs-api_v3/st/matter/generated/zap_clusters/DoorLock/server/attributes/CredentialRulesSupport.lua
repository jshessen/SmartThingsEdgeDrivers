...
--- @alias CredentialRulesSupport
---
--- @field public ID number 0x001B the ID of this attribute
--- @field public NAME string "CredentialRulesSupport" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local CredentialRulesSupport = {
  ID = 0x001B,
  NAME = "CredentialRulesSupport",
  base_type = data_types.Uint8,
}

CredentialRulesSupport.enum_fields = {
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint8 the base data type object to add functionality to
function CredentialRulesSupport:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function CredentialRulesSupport.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, CredentialRulesSupport.enum_fields[value_obj.value])
end
...
function CredentialRulesSupport:new_value(...)
...
function CredentialRulesSupport:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CredentialRulesSupport:subscribe(device, endpoint_id)
...
function CredentialRulesSupport:set_parent_cluster(cluster)
...
function CredentialRulesSupport:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CredentialRulesSupport:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(CredentialRulesSupport, {__call = CredentialRulesSupport.new_value})
