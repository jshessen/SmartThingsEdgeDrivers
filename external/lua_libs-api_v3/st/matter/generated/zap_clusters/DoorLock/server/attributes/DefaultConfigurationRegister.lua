...
DefaultConfigurationRegister.enum_fields = {
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint16 the base data type object to add functionality to
...
function DefaultConfigurationRegister.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, DefaultConfigurationRegister.enum_fields[value_obj.value])
end
...
function DefaultConfigurationRegister:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function DefaultConfigurationRegister:subscribe(device, endpoint_id)
...
function DefaultConfigurationRegister:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function DefaultConfigurationRegister:deserialize(tlv_buf)
