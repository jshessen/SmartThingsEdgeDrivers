...
function DoorClosedEvents:read(device, endpoint_id)
...
function DoorClosedEvents:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function DoorClosedEvents:subscribe(device, endpoint_id)
...
function DoorClosedEvents:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function DoorClosedEvents:deserialize(tlv_buf)
