...
function DoorOpenEvents:read(device, endpoint_id)
...
function DoorOpenEvents:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function DoorOpenEvents:subscribe(device, endpoint_id)
...
function DoorOpenEvents:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function DoorOpenEvents:deserialize(tlv_buf)
