...
function EnableInsideStatusLED:read(device, endpoint_id)
...
function EnableInsideStatusLED:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function EnableInsideStatusLED:subscribe(device, endpoint_id)
...
function EnableInsideStatusLED:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function EnableInsideStatusLED:deserialize(tlv_buf)
