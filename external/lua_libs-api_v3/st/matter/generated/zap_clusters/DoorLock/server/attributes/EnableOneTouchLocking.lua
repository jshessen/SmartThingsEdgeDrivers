...
function EnableOneTouchLocking:read(device, endpoint_id)
...
function EnableOneTouchLocking:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function EnableOneTouchLocking:subscribe(device, endpoint_id)
...
function EnableOneTouchLocking:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function EnableOneTouchLocking:deserialize(tlv_buf)
