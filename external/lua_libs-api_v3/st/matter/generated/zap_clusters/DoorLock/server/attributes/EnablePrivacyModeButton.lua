...
function EnablePrivacyModeButton:read(device, endpoint_id)
...
function EnablePrivacyModeButton:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function EnablePrivacyModeButton:subscribe(device, endpoint_id)
...
function EnablePrivacyModeButton:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function EnablePrivacyModeButton:deserialize(tlv_buf)
