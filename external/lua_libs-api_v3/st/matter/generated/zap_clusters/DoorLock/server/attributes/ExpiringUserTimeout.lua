...
function ExpiringUserTimeout:new_value(...)
...
function ExpiringUserTimeout:read(device, endpoint_id)
...
function ExpiringUserTimeout:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ExpiringUserTimeout:subscribe(device, endpoint_id)
...
function ExpiringUserTimeout:set_parent_cluster(cluster)
...
function ExpiringUserTimeout:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ExpiringUserTimeout:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(ExpiringUserTimeout, {__call = ExpiringUserTimeout.new_value})
