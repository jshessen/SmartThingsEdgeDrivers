...
function LEDSettings:read(device, endpoint_id)
...
function LEDSettings:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LEDSettings:subscribe(device, endpoint_id)
...
function LEDSettings:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LEDSettings:deserialize(tlv_buf)
