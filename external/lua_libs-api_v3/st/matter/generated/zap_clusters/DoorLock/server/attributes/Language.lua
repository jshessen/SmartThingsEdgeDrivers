...
function Language:read(device, endpoint_id)
...
function Language:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function Language:subscribe(device, endpoint_id)
...
function Language:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Language:deserialize(tlv_buf)
