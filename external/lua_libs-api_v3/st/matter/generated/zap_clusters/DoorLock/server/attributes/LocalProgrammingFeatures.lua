...
--- @alias LocalProgrammingFeatures
---
--- @field public ID number 0x002C the ID of this attribute
--- @field public NAME string "LocalProgrammingFeatures" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local LocalProgrammingFeatures = {
  ID = 0x002C,
  NAME = "LocalProgrammingFeatures",
  base_type = data_types.Uint8,
}

LocalProgrammingFeatures.enum_fields = {
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint8 the base data type object to add functionality to
function LocalProgrammingFeatures:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function LocalProgrammingFeatures.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, LocalProgrammingFeatures.enum_fields[value_obj.value])
end
...
function LocalProgrammingFeatures:new_value(...)
...
function LocalProgrammingFeatures:read(device, endpoint_id)
...
function LocalProgrammingFeatures:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LocalProgrammingFeatures:subscribe(device, endpoint_id)
...
function LocalProgrammingFeatures:set_parent_cluster(cluster)
...
function LocalProgrammingFeatures:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LocalProgrammingFeatures:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(LocalProgrammingFeatures, {__call = LocalProgrammingFeatures.new_value})
