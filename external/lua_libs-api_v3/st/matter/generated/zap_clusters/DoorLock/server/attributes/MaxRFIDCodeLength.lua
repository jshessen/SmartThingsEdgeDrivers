...
function MaxRFIDCodeLength:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxRFIDCodeLength:subscribe(device, endpoint_id)
...
function MaxRFIDCodeLength:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxRFIDCodeLength:deserialize(tlv_buf)
