...
function MinRFIDCodeLength:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MinRFIDCodeLength:subscribe(device, endpoint_id)
...
function MinRFIDCodeLength:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinRFIDCodeLength:deserialize(tlv_buf)
