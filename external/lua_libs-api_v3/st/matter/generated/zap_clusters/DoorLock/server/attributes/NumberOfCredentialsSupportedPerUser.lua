...
--- @alias NumberOfCredentialsSupportedPerUser
---
--- @field public ID number 0x001C the ID of this attribute
--- @field public NAME string "NumberOfCredentialsSupportedPerUser" the name of this attribute
...
setmetatable(NumberOfCredentialsSupportedPerUser, {__call = NumberOfCredentialsSupportedPerUser.new_value})
