...
function NumberOfHolidaySchedulesSupported:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfHolidaySchedulesSupported:subscribe(device, endpoint_id)
...
function NumberOfHolidaySchedulesSupported:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfHolidaySchedulesSupported:deserialize(tlv_buf)
