...
function NumberOfRFIDUsersSupported:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfRFIDUsersSupported:subscribe(device, endpoint_id)
...
function NumberOfRFIDUsersSupported:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfRFIDUsersSupported:deserialize(tlv_buf)
