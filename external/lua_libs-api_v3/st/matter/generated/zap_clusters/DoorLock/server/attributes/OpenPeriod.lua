...
function OpenPeriod:read(device, endpoint_id)
...
function OpenPeriod:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function OpenPeriod:subscribe(device, endpoint_id)
...
function OpenPeriod:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OpenPeriod:deserialize(tlv_buf)
