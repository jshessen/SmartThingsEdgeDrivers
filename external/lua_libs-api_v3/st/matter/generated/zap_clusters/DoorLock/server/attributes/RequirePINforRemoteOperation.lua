...
--- @alias RequirePINforRemoteOperation
---
--- @field public ID number 0x0033 the ID of this attribute
--- @field public NAME string "RequirePINforRemoteOperation" the name of this attribute
...
setmetatable(RequirePINforRemoteOperation, {__call = RequirePINforRemoteOperation.new_value})
