...
function SoundVolume:read(device, endpoint_id)
...
function SoundVolume:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function SoundVolume:subscribe(device, endpoint_id)
...
function SoundVolume:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SoundVolume:deserialize(tlv_buf)
