...
SupportedOperatingModes.enum_fields = {
}
...
function SupportedOperatingModes.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, SupportedOperatingModes.enum_fields[value_obj.value])
end
