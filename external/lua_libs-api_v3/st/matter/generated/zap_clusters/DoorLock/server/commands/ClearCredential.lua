...
-----------------------------------------------------------
-- DoorLock command ClearCredential
-----------------------------------------------------------

--- @class st.matter.clusters.DoorLock.ClearCredential
--- @alias ClearCredential
---
--- @field public ID number 0x0026 the ID of this command
--- @field public NAME string "ClearCredential" the name of this command
...
---
--- @param self ClearCredential the template class for this command
--- @param device st.matter.Device the device to build this message to
