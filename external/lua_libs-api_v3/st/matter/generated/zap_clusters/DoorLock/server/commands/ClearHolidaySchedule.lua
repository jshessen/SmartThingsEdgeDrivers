...
---
--- @field public ID number 0x0013 the ID of this command
...
ClearHolidaySchedule.ID = 0x0013
ClearHolidaySchedule.field_defs = {
  {
    name = "holiday_index",
    field_id = 0,
    optional = false,
...
function ClearHolidaySchedule:build_test_command_response(device, endpoint_id, status)
...
function ClearHolidaySchedule:init(device, endpoint_id, holiday_index)
  local out = {}
  local args = {holiday_index}
...
function ClearHolidaySchedule:augment_type(base_type_obj)
  local elems = {}
...
function ClearHolidaySchedule:deserialize(tlv_buf)
