...
-----------------------------------------------------------
-- DoorLock command ClearUser
-----------------------------------------------------------

--- @class st.matter.clusters.DoorLock.ClearUser
--- @alias ClearUser
---
--- @field public ID number 0x001D the ID of this command
--- @field public NAME string "ClearUser" the name of this command
...
---
--- @param self ClearUser the template class for this command
--- @param device st.matter.Device the device to build this message to
