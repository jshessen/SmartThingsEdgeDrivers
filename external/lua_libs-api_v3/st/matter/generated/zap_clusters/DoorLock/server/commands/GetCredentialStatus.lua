...
-----------------------------------------------------------
-- DoorLock command GetCredentialStatus
-----------------------------------------------------------

--- @class st.matter.clusters.DoorLock.GetCredentialStatus
--- @alias GetCredentialStatus
---
--- @field public ID number 0x0024 the ID of this command
--- @field public NAME string "GetCredentialStatus" the name of this command
...
--- Initialize the GetCredentialStatus command
---
--- @param self GetCredentialStatus the template class for this command
