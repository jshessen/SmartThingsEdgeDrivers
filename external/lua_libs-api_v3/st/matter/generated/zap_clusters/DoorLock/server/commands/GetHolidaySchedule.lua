...
GetHolidaySchedule.ID = 0x0012
GetHolidaySchedule.field_defs = {
  {
    name = "holiday_index",
    field_id = 0,
    optional = false,
...
function GetHolidaySchedule:init(device, endpoint_id, holiday_index)
  local out = {}
...
function GetHolidaySchedule:augment_type(base_type_obj)
  local elems = {}
...
function GetHolidaySchedule:deserialize(tlv_buf)
