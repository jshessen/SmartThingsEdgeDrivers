...
-----------------------------------------------------------
-- DoorLock command GetUser
-----------------------------------------------------------

--- @class st.matter.clusters.DoorLock.GetUser
--- @alias GetUser
---
--- @field public ID number 0x001B the ID of this command
--- @field public NAME string "GetUser" the name of this command
...
--- Initialize the GetUser command
---
--- @param self GetUser the template class for this command
