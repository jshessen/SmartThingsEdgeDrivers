...
function UnlockWithTimeout:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param timeout st.matter.data_types.Uint16
--- @param pin_code st.matter.data_types.OctetString1

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function UnlockWithTimeout:init(device, endpoint_id, timeout, pin_code)
  local out = {}
  local args = {timeout, pin_code}
...
function UnlockWithTimeout:augment_type(base_type_obj)
  local elems = {}
...
function UnlockWithTimeout:deserialize(tlv_buf)
