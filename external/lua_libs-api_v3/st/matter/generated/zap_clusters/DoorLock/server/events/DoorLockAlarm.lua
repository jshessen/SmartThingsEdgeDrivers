...
local DlAlarmCode = require "st.matter.generated.zap_clusters.DoorLock.types.DlAlarmCode"

--- @class st.matter.clusters.DoorLock.DoorLockAlarm
--- @alias DoorLockAlarm
---
--- @field public ID number 0x0000 the ID of this event
--- @field public NAME string "DoorLockAlarm" the name of this event
--- @field public alarm_code st.matter.clusters.DoorLock.types.DlAlarmCode
local DoorLockAlarm = {
  ID = 0x0000,
  NAME = "DoorLockAlarm",
