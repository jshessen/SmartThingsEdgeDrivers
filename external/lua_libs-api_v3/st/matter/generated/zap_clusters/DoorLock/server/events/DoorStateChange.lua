...
local DlDoorState = require "st.matter.generated.zap_clusters.DoorLock.types.DlDoorState"

--- @class st.matter.clusters.DoorLock.DoorStateChange
--- @alias DoorStateChange
---
--- @field public ID number 0x0001 the ID of this event
--- @field public NAME string "DoorStateChange" the name of this event
--- @field public door_state st.matter.clusters.DoorLock.types.DlDoorState
