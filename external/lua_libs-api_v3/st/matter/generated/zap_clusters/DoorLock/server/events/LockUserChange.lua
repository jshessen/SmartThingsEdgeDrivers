...
local DlLockDataType = require "st.matter.generated.zap_clusters.DoorLock.types.DlLockDataType"
local DlDataOperationType = require "st.matter.generated.zap_clusters.DoorLock.types.DlDataOperationType"
...
--- @alias LockUserChange
---
--- @field public ID number 0x0004 the ID of this event
--- @field public NAME string "LockUserChange" the name of this event
--- @field public lock_data_type st.matter.clusters.DoorLock.types.DlLockDataType
--- @field public data_operation_type st.matter.clusters.DoorLock.types.DlDataOperationType
...
--- @field public data_index data_types.Uint16
