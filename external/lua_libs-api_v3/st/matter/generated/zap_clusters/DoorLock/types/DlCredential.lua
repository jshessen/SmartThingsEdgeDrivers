...
local DlCredentialType = require "st.matter.generated.zap_clusters.DoorLock.types.DlCredentialType"

--- @alias DlCredential
--- @class st.matter.clusters.DoorLock.types.DlCredential: st.matter.data_types.Structure
---
--- @field public credential_type DlCredentialType
--- @field public credential_index st.matter.data_types.Uint16
local DlCredential = {}
local new_mt = StructureABC.new_mt({NAME = "DlCredential", ID = data_types.name_to_id_map["Structure"]})

DlCredential.field_defs = {
  {
...
DlCredential.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
DlCredential.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = DlCredential.init
new_mt.__index.serialize = DlCredential.serialize

DlCredential.augment_type = function(self, val)
  local elems = {}
...
setmetatable(DlCredential, new_mt)
