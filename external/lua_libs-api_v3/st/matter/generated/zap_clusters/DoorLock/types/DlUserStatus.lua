...
local DlUserStatus = {}
local new_mt = UintABC.new_mt({NAME = "DlUserStatus", ID = data_types.name_to_id_map["Uint8"]}, 1)
...
DlUserStatus.augment_type = function(cls, val)
  setmetatable(val, new_mt)
end

setmetatable(DlUserStatus, new_mt)
