...
--- @alias DoorLockOperationEventCode
---
--- @field public byte_length number 1
--- @field public UNKNOWN_OR_MFG_SPECIFIC number 0
--- @field public LOCK number 1
--- @field public UNLOCK number 2
--- @field public LOCK_INVALID_PIN_OR_ID number 3
--- @field public LOCK_INVALID_SCHEDULE number 4
--- @field public UNLOCK_INVALID_PIN_OR_ID number 5
--- @field public UNLOCK_INVALID_SCHEDULE number 6
