...
--- @class st.matter.clusters.FanControl.FanModeSequence
...
FanModeSequence.OFF_LOW_MED_HIGH = 0x00
FanModeSequence.OFF_LOW_HIGH = 0x01
FanModeSequence.OFF_LOW_MED_HIGH_AUTO = 0x02
FanModeSequence.OFF_LOW_HIGH_AUTO = 0x03
FanModeSequence.OFF_ON_AUTO = 0x04
FanModeSequence.OFF_ON = 0x05

FanModeSequence.enum_fields = {
  [FanModeSequence.OFF_LOW_MED_HIGH] = "OFF_LOW_MED_HIGH",
  [FanModeSequence.OFF_LOW_HIGH] = "OFF_LOW_HIGH",
  [FanModeSequence.OFF_LOW_MED_HIGH_AUTO] = "OFF_LOW_MED_HIGH_AUTO",
  [FanModeSequence.OFF_LOW_HIGH_AUTO] = "OFF_LOW_HIGH_AUTO",
  [FanModeSequence.OFF_ON_AUTO] = "OFF_ON_AUTO",
  [FanModeSequence.OFF_ON] = "OFF_ON",
}
...
function FanModeSequence.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, FanModeSequence.enum_fields[value_obj.value])
end
...
function FanModeSequence:read(device, endpoint_id)
...
function FanModeSequence:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function FanModeSequence:subscribe(device, endpoint_id)
...
function FanModeSequence:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function FanModeSequence:deserialize(tlv_buf)
