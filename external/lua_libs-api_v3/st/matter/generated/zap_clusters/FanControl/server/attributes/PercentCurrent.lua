...
--- @class st.matter.clusters.FanControl.PercentCurrent
--- @alias PercentCurrent
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "PercentCurrent" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local PercentCurrent = {
  ID = 0x0003,
  NAME = "PercentCurrent",
...
function PercentCurrent:new_value(...)
...
function PercentCurrent:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PercentCurrent:subscribe(device, endpoint_id)
...
function PercentCurrent:set_parent_cluster(cluster)
...
function PercentCurrent:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PercentCurrent:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(PercentCurrent, {__call = PercentCurrent.new_value})
