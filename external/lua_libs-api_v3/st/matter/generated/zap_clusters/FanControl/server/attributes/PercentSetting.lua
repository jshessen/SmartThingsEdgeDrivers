...
--- @class st.matter.clusters.FanControl.PercentSetting
--- @alias PercentSetting
---
--- @field public ID number 0x0002 the ID of this attribute
--- @field public NAME string "PercentSetting" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local PercentSetting = {
  ID = 0x0002,
  NAME = "PercentSetting",
...
function PercentSetting:new_value(...)
...
function PercentSetting:read(device, endpoint_id)
...
function PercentSetting:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function PercentSetting:subscribe(device, endpoint_id)
...
function PercentSetting:set_parent_cluster(cluster)
...
function PercentSetting:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PercentSetting:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(PercentSetting, {__call = PercentSetting.new_value})
