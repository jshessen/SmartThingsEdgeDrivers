...
--- @class st.matter.clusters.FanControl.RockSetting
--- @alias RockSetting
---
--- @field public ID number 0x0008 the ID of this attribute
--- @field public NAME string "RockSetting" the name of this attribute
...
function RockSetting:new_value(...)
...
function RockSetting:read(device, endpoint_id)
...
function RockSetting:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function RockSetting:subscribe(device, endpoint_id)
...
function RockSetting:set_parent_cluster(cluster)
...
function RockSetting:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function RockSetting:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(RockSetting, {__call = RockSetting.new_value})
return RockSetting
