...
--- @class st.matter.clusters.FanControl.RockSupport
--- @alias RockSupport
---
--- @field public ID number 0x0007 the ID of this attribute
--- @field public NAME string "RockSupport" the name of this attribute
...
function RockSupport:new_value(...)
...
function RockSupport:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function RockSupport:subscribe(device, endpoint_id)
...
function RockSupport:set_parent_cluster(cluster)
...
function RockSupport:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function RockSupport:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(RockSupport, {__call = RockSupport.new_value})
return RockSupport
