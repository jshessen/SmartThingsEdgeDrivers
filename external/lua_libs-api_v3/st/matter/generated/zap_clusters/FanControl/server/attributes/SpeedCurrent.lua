...
--- @class st.matter.clusters.FanControl.SpeedCurrent
--- @alias SpeedCurrent
---
--- @field public ID number 0x0006 the ID of this attribute
--- @field public NAME string "SpeedCurrent" the name of this attribute
...
function SpeedCurrent:new_value(...)
...
function SpeedCurrent:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SpeedCurrent:subscribe(device, endpoint_id)
...
function SpeedCurrent:set_parent_cluster(cluster)
...
function SpeedCurrent:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SpeedCurrent:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(SpeedCurrent, {__call = SpeedCurrent.new_value})
return SpeedCurrent
