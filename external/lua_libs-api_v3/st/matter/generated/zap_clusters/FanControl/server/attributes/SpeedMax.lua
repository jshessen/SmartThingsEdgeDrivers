...
--- @class st.matter.clusters.FanControl.SpeedMax
--- @alias SpeedMax
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "SpeedMax" the name of this attribute
...
function SpeedMax:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SpeedMax:subscribe(device, endpoint_id)
...
function SpeedMax:set_parent_cluster(cluster)
...
function SpeedMax:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SpeedMax:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(SpeedMax, {__call = SpeedMax.new_value})
return SpeedMax
