...
--- @class st.matter.clusters.FanControl.SpeedSetting
--- @alias SpeedSetting
---
--- @field public ID number 0x0005 the ID of this attribute
--- @field public NAME string "SpeedSetting" the name of this attribute
...
function SpeedSetting:new_value(...)
...
function SpeedSetting:read(device, endpoint_id)
...
function SpeedSetting:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function SpeedSetting:subscribe(device, endpoint_id)
...
function SpeedSetting:set_parent_cluster(cluster)
...
function SpeedSetting:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SpeedSetting:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(SpeedSetting, {__call = SpeedSetting.new_value})
return SpeedSetting
