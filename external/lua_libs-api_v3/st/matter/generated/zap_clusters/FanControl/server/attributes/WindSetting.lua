...
--- @class st.matter.clusters.FanControl.WindSetting
--- @alias WindSetting
---
--- @field public ID number 0x000A the ID of this attribute
--- @field public NAME string "WindSetting" the name of this attribute
...
function WindSetting:new_value(...)
...
function WindSetting:read(device, endpoint_id)
...
function WindSetting:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function WindSetting:subscribe(device, endpoint_id)
...
function WindSetting:set_parent_cluster(cluster)
...
function WindSetting:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WindSetting:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(WindSetting, {__call = WindSetting.new_value})
return WindSetting
