...
--- @class st.matter.clusters.FanControl.WindSupport
--- @alias WindSupport
---
--- @field public ID number 0x0009 the ID of this attribute
--- @field public NAME string "WindSupport" the name of this attribute
...
function WindSupport:new_value(...)
...
function WindSupport:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function WindSupport:subscribe(device, endpoint_id)
...
function WindSupport:set_parent_cluster(cluster)
...
function WindSupport:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WindSupport:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(WindSupport, {__call = WindSupport.new_value})
return WindSupport
