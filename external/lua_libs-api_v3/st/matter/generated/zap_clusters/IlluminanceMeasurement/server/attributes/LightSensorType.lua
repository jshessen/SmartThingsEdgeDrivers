...
--- @class st.matter.clusters.IlluminanceMeasurement.LightSensorType
...
function LightSensorType:read(device, endpoint_id)
...
--- Reporting policy: LightSensorType => true => mandatory
...
--- @param endpoint_id number|nil
--- @return any
function LightSensorType:subscribe(device, endpoint_id)
...
--- Builds an LightSensorType test attribute reponse for the driver integration testing framework
---
...
function LightSensorType:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LightSensorType:deserialize(tlv_buf)
