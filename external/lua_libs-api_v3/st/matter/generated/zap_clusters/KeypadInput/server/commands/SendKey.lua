...
local CecKeyCodeType = require "st.matter.generated.zap_clusters.KeypadInput.types.CecKeyCode"

-----------------------------------------------------------
-- KeypadInput command SendKey
-----------------------------------------------------------
...
--- @field public NAME string "SendKey" the name of this command
--- @field public key_code st.matter.clusters.KeypadInput.types.CecKeyCode
local SendKey = {}

SendKey.NAME = "SendKey"
SendKey.ID = 0x0000
SendKey.field_defs = {
  {
    name = "key_code",
...
--- Initialize the SendKey command
---
--- @param self SendKey the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param key_code st.matter.clusters.KeypadInput.types.CecKeyCode

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function SendKey:init(device, endpoint_id, key_code)
  local out = {}
  local args = {key_code}
  ...
  setmetatable(out, {
    __index = SendKey,
    __tostring = SendKey.pretty_print
  })
...
function SendKey:set_parent_cluster(cluster)
...
function SendKey:augment_type(base_type_obj)
  local elems = {}
...
function SendKey:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(SendKey, {__call = SendKey.init})
