...
--- @class st.matter.clusters.LevelControl.CurrentFrequency
...
function CurrentFrequency:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentFrequency:subscribe(device, endpoint_id)
...
function CurrentFrequency:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentFrequency:deserialize(tlv_buf)
