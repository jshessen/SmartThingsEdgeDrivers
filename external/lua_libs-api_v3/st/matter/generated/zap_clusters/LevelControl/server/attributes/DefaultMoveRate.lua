...
--- @class st.matter.clusters.LevelControl.DefaultMoveRate
...
function DefaultMoveRate:read(device, endpoint_id)
...
function DefaultMoveRate:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function DefaultMoveRate:subscribe(device, endpoint_id)
...
function DefaultMoveRate:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function DefaultMoveRate:deserialize(tlv_buf)
