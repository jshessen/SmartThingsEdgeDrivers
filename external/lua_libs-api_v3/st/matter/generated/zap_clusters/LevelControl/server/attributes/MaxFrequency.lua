...
--- @class st.matter.clusters.LevelControl.MaxFrequency
--- @alias MaxFrequency
---
...
function MaxFrequency:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxFrequency:subscribe(device, endpoint_id)
...
function MaxFrequency:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxFrequency:deserialize(tlv_buf)
