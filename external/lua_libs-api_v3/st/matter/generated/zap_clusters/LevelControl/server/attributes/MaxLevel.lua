...
--- @class st.matter.clusters.LevelControl.MaxLevel
--- @alias MaxLevel
---
...
function MaxLevel:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MaxLevel:subscribe(device, endpoint_id)
...
function MaxLevel:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxLevel:deserialize(tlv_buf)
