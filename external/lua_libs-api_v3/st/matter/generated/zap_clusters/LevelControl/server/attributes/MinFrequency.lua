...
--- @class st.matter.clusters.LevelControl.MinFrequency
--- @alias MinFrequency
---
...
function MinFrequency:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MinFrequency:subscribe(device, endpoint_id)
...
function MinFrequency:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinFrequency:deserialize(tlv_buf)
