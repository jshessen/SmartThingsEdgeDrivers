...
--- @class st.matter.clusters.LevelControl.MinLevel
--- @alias MinLevel
---
...
function MinLevel:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MinLevel:subscribe(device, endpoint_id)
...
function MinLevel:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinLevel:deserialize(tlv_buf)
