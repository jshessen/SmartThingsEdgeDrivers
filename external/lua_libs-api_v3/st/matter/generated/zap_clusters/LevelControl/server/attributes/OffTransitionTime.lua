...
--- @class st.matter.clusters.LevelControl.OffTransitionTime
...
function OffTransitionTime:read(device, endpoint_id)
...
function OffTransitionTime:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function OffTransitionTime:subscribe(device, endpoint_id)
...
function OffTransitionTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OffTransitionTime:deserialize(tlv_buf)
