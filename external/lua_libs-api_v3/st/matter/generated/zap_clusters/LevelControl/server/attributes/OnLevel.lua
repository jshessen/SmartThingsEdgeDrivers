...
--- @class st.matter.clusters.LevelControl.OnLevel
--- @alias OnLevel
---
...
function OnLevel:read(device, endpoint_id)
...
function OnLevel:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function OnLevel:subscribe(device, endpoint_id)
...
function OnLevel:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OnLevel:deserialize(tlv_buf)
