...
--- @class st.matter.clusters.LevelControl.OnOffTransitionTime
...
function OnOffTransitionTime:read(device, endpoint_id)
...
function OnOffTransitionTime:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function OnOffTransitionTime:subscribe(device, endpoint_id)
...
function OnOffTransitionTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OnOffTransitionTime:deserialize(tlv_buf)
