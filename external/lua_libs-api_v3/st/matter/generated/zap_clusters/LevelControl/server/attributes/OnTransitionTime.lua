...
--- @class st.matter.clusters.LevelControl.OnTransitionTime
...
function OnTransitionTime:read(device, endpoint_id)
...
function OnTransitionTime:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function OnTransitionTime:subscribe(device, endpoint_id)
...
function OnTransitionTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OnTransitionTime:deserialize(tlv_buf)
