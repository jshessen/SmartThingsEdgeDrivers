...
--- @class st.matter.clusters.LevelControl.Options
--- @alias Options
---
...
function Options:read(device, endpoint_id)
...
function Options:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function Options:subscribe(device, endpoint_id)
...
function Options:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Options:deserialize(tlv_buf)
