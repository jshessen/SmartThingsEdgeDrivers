...
--- @class st.matter.clusters.LevelControl.RemainingTime
--- @alias RemainingTime
---
...
function RemainingTime:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function RemainingTime:subscribe(device, endpoint_id)
...
function RemainingTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function RemainingTime:deserialize(tlv_buf)
