...
--- @class st.matter.clusters.LevelControl.StartUpCurrentLevel
...
function StartUpCurrentLevel:read(device, endpoint_id)
...
function StartUpCurrentLevel:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function StartUpCurrentLevel:subscribe(device, endpoint_id)
...
function StartUpCurrentLevel:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function StartUpCurrentLevel:deserialize(tlv_buf)
