...
-----------------------------------------------------------
-- LevelControl command Move
-----------------------------------------------------------

--- @class st.matter.clusters.LevelControl.Move
--- @alias Move
---
...
function Move:build_test_command_response(device, endpoint_id, status)
...
function Move:init(device, endpoint_id, move_mode, rate, options_mask, options_override)
  local out = {}
...
function Move:augment_type(base_type_obj)
  local elems = {}
...
function Move:deserialize(tlv_buf)
