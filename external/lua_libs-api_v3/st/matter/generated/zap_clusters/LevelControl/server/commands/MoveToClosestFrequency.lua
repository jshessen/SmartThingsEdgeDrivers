...
-----------------------------------------------------------
-- LevelControl command MoveToClosestFrequency
-----------------------------------------------------------

--- @class st.matter.clusters.LevelControl.MoveToClosestFrequency
...
--- @field public frequency data_types.Uint16
local MoveToClosestFrequency = {}

MoveToClosestFrequency.NAME = "MoveToClosestFrequency"
MoveToClosestFrequency.ID = 0x0008
MoveToClosestFrequency.field_defs = {
  {
    name = "frequency",
    field_id = 0,
    optional = false,
...
function MoveToClosestFrequency:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param frequency st.matter.data_types.Uint16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function MoveToClosestFrequency:init(device, endpoint_id, frequency)
  local out = {}
...
function MoveToClosestFrequency:augment_type(base_type_obj)
  local elems = {}
...
function MoveToClosestFrequency:deserialize(tlv_buf)
