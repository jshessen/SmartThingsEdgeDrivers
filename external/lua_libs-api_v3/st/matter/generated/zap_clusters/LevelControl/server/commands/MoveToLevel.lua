...
-----------------------------------------------------------
-- LevelControl command MoveToLevel
-----------------------------------------------------------

--- @class st.matter.clusters.LevelControl.MoveToLevel
--- @alias MoveToLevel
---
--- @field public ID number 0x0000 the ID of this command
--- @field public NAME string "MoveToLevel" the name of this command
--- @field public level data_types.Uint8
...
MoveToLevel.ID = 0x0000
MoveToLevel.field_defs = {
  {
    name = "level",
    field_id = 0,
    optional = false,
...
function MoveToLevel:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param level st.matter.data_types.Uint8
...
function MoveToLevel:init(device, endpoint_id, level, transition_time, options_mask, options_override)
  local out = {}
...
function MoveToLevel:augment_type(base_type_obj)
  local elems = {}
...
function MoveToLevel:deserialize(tlv_buf)
