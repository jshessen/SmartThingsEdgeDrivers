...
-----------------------------------------------------------
-- LevelControl command MoveToLevelWithOnOff
-----------------------------------------------------------

--- @class st.matter.clusters.LevelControl.MoveToLevelWithOnOff
...
MoveToLevelWithOnOff.ID = 0x0004
MoveToLevelWithOnOff.field_defs = {
  {
    name = "level",
    field_id = 0,
    optional = false,
...
function MoveToLevelWithOnOff:build_test_command_response(device, endpoint_id, status)
...
function MoveToLevelWithOnOff:augment_type(base_type_obj)
  local elems = {}
...
function MoveToLevelWithOnOff:deserialize(tlv_buf)
