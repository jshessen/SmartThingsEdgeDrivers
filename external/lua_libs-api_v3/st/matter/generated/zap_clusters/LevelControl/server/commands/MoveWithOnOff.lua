...
local MoveModeType = require "st.matter.generated.zap_clusters.LevelControl.types.MoveMode"

-----------------------------------------------------------
-- LevelControl command MoveWithOnOff
-----------------------------------------------------------

--- @class st.matter.clusters.LevelControl.MoveWithOnOff
--- @alias MoveWithOnOff
---
--- @field public ID number 0x0005 the ID of this command
--- @field public NAME string "MoveWithOnOff" the name of this command
--- @field public move_mode st.matter.clusters.LevelControl.types.MoveMode
...
MoveWithOnOff.ID = 0x0005
MoveWithOnOff.field_defs = {
  {
    name = "move_mode",
    field_id = 0,
    optional = false,
    nullable = false,
    data_type = MoveModeType,
  },
  {
    name = "rate",
    field_id = 1,
...
function MoveWithOnOff:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param move_mode st.matter.clusters.LevelControl.types.MoveMode
...
function MoveWithOnOff:init(device, endpoint_id, move_mode, rate, options_mask, options_override)
  local out = {}
...
function MoveWithOnOff:augment_type(base_type_obj)
  local elems = {}
...
function MoveWithOnOff:deserialize(tlv_buf)
