...
-----------------------------------------------------------
-- LevelControl command Step
-----------------------------------------------------------

--- @class st.matter.clusters.LevelControl.Step
--- @alias Step
---
...
function Step:init(device, endpoint_id, step_mode, step_size, transition_time, options_mask, options_override)
  local out = {}
