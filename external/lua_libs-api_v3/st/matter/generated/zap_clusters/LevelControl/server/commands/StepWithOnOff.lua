...
local StepModeType = require "st.matter.generated.zap_clusters.LevelControl.types.StepMode"

-----------------------------------------------------------
-- LevelControl command StepWithOnOff
-----------------------------------------------------------

--- @class st.matter.clusters.LevelControl.StepWithOnOff
--- @alias StepWithOnOff
---
--- @field public ID number 0x0006 the ID of this command
--- @field public NAME string "StepWithOnOff" the name of this command
--- @field public step_mode st.matter.clusters.LevelControl.types.StepMode
...
StepWithOnOff.ID = 0x0006
StepWithOnOff.field_defs = {
  {
    name = "step_mode",
    field_id = 0,
    optional = false,
    nullable = false,
    data_type = StepModeType,
  },
  {
    name = "step_size",
    field_id = 1,
...
function StepWithOnOff:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param step_mode st.matter.clusters.LevelControl.types.StepMode
...
function StepWithOnOff:init(device, endpoint_id, step_mode, step_size, transition_time, options_mask, options_override)
  local out = {}
...
function StepWithOnOff:augment_type(base_type_obj)
  local elems = {}
...
function StepWithOnOff:deserialize(tlv_buf)
