...
-----------------------------------------------------------
-- LevelControl command StopWithOnOff
-----------------------------------------------------------

--- @class st.matter.clusters.LevelControl.StopWithOnOff
--- @alias StopWithOnOff
---
...
StopWithOnOff.ID = 0x0007
StopWithOnOff.field_defs = {
  {
    name = "options_mask",
    field_id = 0,
    optional = false,
...
function StopWithOnOff:build_test_command_response(device, endpoint_id, status)
...
function StopWithOnOff:init(device, endpoint_id, options_mask, options_override)
  local out = {}
...
function StopWithOnOff:augment_type(base_type_obj)
  local elems = {}
...
function StopWithOnOff:deserialize(tlv_buf)
