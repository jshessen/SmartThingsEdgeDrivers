...
--- @field public PLAYING number 0
--- @field public PAUSED number 1
--- @field public NOT_PLAYING number 2
--- @field public BUFFERING number 3
...
CurrentState.PLAYING = 0x00
CurrentState.PAUSED = 0x01
CurrentState.NOT_PLAYING = 0x02
CurrentState.BUFFERING = 0x03

CurrentState.enum_fields = {
  [CurrentState.PLAYING] = "PLAYING",
  [CurrentState.PAUSED] = "PAUSED",
  [CurrentState.NOT_PLAYING] = "NOT_PLAYING",
  [CurrentState.BUFFERING] = "BUFFERING",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint8 the base data type object to add functionality to
function CurrentState:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function CurrentState.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, CurrentState.enum_fields[value_obj.value])
end
...
setmetatable(CurrentState, {__call = CurrentState.new_value})
return CurrentState
