...
--- @field public NAME string "Duration" the name of this attribute
...
function Duration:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Duration:subscribe(device, endpoint_id)
...
function Duration:set_parent_cluster(cluster)
...
function Duration:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Duration:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(Duration, {__call = Duration.new_value})
return Duration
