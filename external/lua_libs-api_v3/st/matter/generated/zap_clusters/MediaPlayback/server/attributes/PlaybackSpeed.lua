...
--- @field public NAME string "PlaybackSpeed" the name of this attribute
--- @field public data_type st.matter.data_types.SinglePrecisionFloat the data type of this attribute
...
--- @return st.matter.data_types.SinglePrecisionFloat
function PlaybackSpeed:new_value(...)
...
function PlaybackSpeed:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PlaybackSpeed:subscribe(device, endpoint_id)
...
function PlaybackSpeed:set_parent_cluster(cluster)
...
function PlaybackSpeed:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PlaybackSpeed:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(PlaybackSpeed, {__call = PlaybackSpeed.new_value})
