...
--- @field public NAME string "SeekRangeEnd" the name of this attribute
...
function SeekRangeEnd:new_value(...)
...
function SeekRangeEnd:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SeekRangeEnd:subscribe(device, endpoint_id)
...
function SeekRangeEnd:set_parent_cluster(cluster)
...
function SeekRangeEnd:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SeekRangeEnd:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(SeekRangeEnd, {__call = SeekRangeEnd.new_value})
return SeekRangeEnd
