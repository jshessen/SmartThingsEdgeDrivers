...
--- @alias SeekRangeStart
---
--- @field public ID number 0x0006 the ID of this attribute
--- @field public NAME string "SeekRangeStart" the name of this attribute
--- @field public data_type st.matter.data_types.Uint64 the data type of this attribute

local SeekRangeStart = {
  ID = 0x0006,
  NAME = "SeekRangeStart",
  base_type = data_types.Uint64,
}
...
--- @return st.matter.data_types.Uint64
function SeekRangeStart:new_value(...)
...
function SeekRangeStart:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SeekRangeStart:subscribe(device, endpoint_id)
...
function SeekRangeStart:set_parent_cluster(cluster)
...
function SeekRangeStart:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SeekRangeStart:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(SeekRangeStart, {__call = SeekRangeStart.new_value})
