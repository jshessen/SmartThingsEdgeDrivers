...
--- @field public NAME string "StartTime" the name of this attribute
...
function StartTime:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function StartTime:subscribe(device, endpoint_id)
...
function StartTime:set_parent_cluster(cluster)
...
function StartTime:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function StartTime:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(StartTime, {__call = StartTime.new_value})
return StartTime
