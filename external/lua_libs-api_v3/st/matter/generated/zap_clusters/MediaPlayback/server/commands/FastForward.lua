...
-----------------------------------------------------------
-- MediaPlayback command FastForward
-----------------------------------------------------------
...
--- @field public NAME string "FastForward" the name of this command
local FastForward = {}

FastForward.NAME = "FastForward"
FastForward.ID = 0x0007
FastForward.field_defs = {
}
...
--- Initialize the FastForward command
---
--- @param self FastForward the template class for this command
...
function FastForward:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = FastForward,
    __tostring = FastForward.pretty_print
  })
...
function FastForward:set_parent_cluster(cluster)
...
function FastForward:augment_type(base_type_obj)
  local elems = {}
...
function FastForward:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(FastForward, {__call = FastForward.init})
