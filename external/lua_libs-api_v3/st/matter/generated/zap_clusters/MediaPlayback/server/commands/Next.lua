...
--- @field public NAME string "Next" the name of this command
local Next = {}
...
---
--- @param self Next the template class for this command
...
function Next:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function Next:set_parent_cluster(cluster)
...
function Next:augment_type(base_type_obj)
  local elems = {}
...
function Next:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(Next, {__call = Next.init})
