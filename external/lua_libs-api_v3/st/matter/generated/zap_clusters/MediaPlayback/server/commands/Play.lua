...
--- @field public NAME string "Play" the name of this command
local Play = {}
...
---
--- @param self Play the template class for this command
...
function Play:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function Play:set_parent_cluster(cluster)
...
function Play:augment_type(base_type_obj)
  local elems = {}
...
function Play:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(Play, {__call = Play.init})
