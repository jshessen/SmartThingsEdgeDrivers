...
-----------------------------------------------------------
-- MediaPlayback command Previous
-----------------------------------------------------------
...
--- @field public NAME string "Previous" the name of this command
local Previous = {}
...
---
--- @param self Previous the template class for this command
...
function Previous:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = Previous,
    __tostring = Previous.pretty_print
  })
...
function Previous:set_parent_cluster(cluster)
...
function Previous:augment_type(base_type_obj)
  local elems = {}
...
function Previous:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(Previous, {__call = Previous.init})
