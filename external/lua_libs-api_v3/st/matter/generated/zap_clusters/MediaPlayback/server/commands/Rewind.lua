...
--- @field public NAME string "Rewind" the name of this command
local Rewind = {}
...
---
--- @param self Rewind the template class for this command
...
function Rewind:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = Rewind,
    __tostring = Rewind.pretty_print
  })
...
function Rewind:set_parent_cluster(cluster)
...
function Rewind:augment_type(base_type_obj)
  local elems = {}
...
function Rewind:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(Rewind, {__call = Rewind.init})
