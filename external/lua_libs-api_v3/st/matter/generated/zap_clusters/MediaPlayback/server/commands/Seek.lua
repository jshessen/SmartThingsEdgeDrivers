...
--- @field public NAME string "Seek" the name of this command
--- @field public position data_types.Uint64
local Seek = {}
...
--- Initialize the Seek command
---
--- @param self Seek the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param position st.matter.data_types.Uint64

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function Seek:init(device, endpoint_id, position)
  local out = {}
  local args = {position}
...
function Seek:set_parent_cluster(cluster)
...
function Seek:augment_type(base_type_obj)
  local elems = {}
...
function Seek:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(Seek, {__call = Seek.init})
