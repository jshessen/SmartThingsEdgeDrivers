...
-----------------------------------------------------------
-- MediaPlayback command SkipBackward
-----------------------------------------------------------
...
--- @field public NAME string "SkipBackward" the name of this command
--- @field public delta_position_milliseconds data_types.Uint64
local SkipBackward = {}

SkipBackward.NAME = "SkipBackward"
SkipBackward.ID = 0x0009
SkipBackward.field_defs = {
  {
...
--- Initialize the SkipBackward command
---
--- @param self SkipBackward the template class for this command
...
function SkipBackward:init(device, endpoint_id, delta_position_milliseconds)
  local out = {}
  ...
  setmetatable(out, {
    __index = SkipBackward,
    __tostring = SkipBackward.pretty_print
  })
...
function SkipBackward:set_parent_cluster(cluster)
...
function SkipBackward:augment_type(base_type_obj)
  local elems = {}
...
function SkipBackward:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(SkipBackward, {__call = SkipBackward.init})
