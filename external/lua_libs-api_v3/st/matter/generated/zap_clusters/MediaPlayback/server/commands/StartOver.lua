...
-----------------------------------------------------------
-- MediaPlayback command StartOver
-----------------------------------------------------------
...
--- @field public NAME string "StartOver" the name of this command
local StartOver = {}

StartOver.NAME = "StartOver"
StartOver.ID = 0x0003
StartOver.field_defs = {
}
...
--- Initialize the StartOver command
---
--- @param self StartOver the template class for this command
...
function StartOver:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = StartOver,
    __tostring = StartOver.pretty_print
  })
...
function StartOver:set_parent_cluster(cluster)
...
function StartOver:augment_type(base_type_obj)
  local elems = {}
...
function StartOver:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(StartOver, {__call = StartOver.init})
