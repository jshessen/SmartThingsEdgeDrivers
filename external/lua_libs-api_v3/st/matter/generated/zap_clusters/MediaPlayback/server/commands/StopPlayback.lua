...
-----------------------------------------------------------
-- MediaPlayback command StopPlayback
-----------------------------------------------------------
...
--- @field public NAME string "StopPlayback" the name of this command
local StopPlayback = {}

StopPlayback.NAME = "StopPlayback"
StopPlayback.ID = 0x0002
StopPlayback.field_defs = {
}
...
--- Initialize the StopPlayback command
---
--- @param self StopPlayback the template class for this command
...
function StopPlayback:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = StopPlayback,
    __tostring = StopPlayback.pretty_print
  })
...
function StopPlayback:set_parent_cluster(cluster)
...
function StopPlayback:augment_type(base_type_obj)
  local elems = {}
...
function StopPlayback:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(StopPlayback, {__call = StopPlayback.init})
