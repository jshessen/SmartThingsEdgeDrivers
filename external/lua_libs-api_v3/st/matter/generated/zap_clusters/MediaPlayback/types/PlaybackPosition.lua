...
--- @alias PlaybackPosition
--- @class st.matter.clusters.MediaPlayback.types.PlaybackPosition: st.matter.data_types.Structure
---
--- @field public updated_at st.matter.data_types.Uint64
--- @field public position st.matter.data_types.Uint64
local PlaybackPosition = {}
local new_mt = StructureABC.new_mt({NAME = "PlaybackPosition", ID = data_types.name_to_id_map["Structure"]})

PlaybackPosition.field_defs = {
  {
...
PlaybackPosition.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
PlaybackPosition.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = PlaybackPosition.init
new_mt.__index.serialize = PlaybackPosition.serialize

PlaybackPosition.augment_type = function(self, val)
  local elems = {}
...
setmetatable(PlaybackPosition, new_mt)
