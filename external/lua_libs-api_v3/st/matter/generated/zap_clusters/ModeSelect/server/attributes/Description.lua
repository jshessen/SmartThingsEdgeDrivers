...
function Description:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Description:subscribe(device, endpoint_id)
...
function Description:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Description:deserialize(tlv_buf)
