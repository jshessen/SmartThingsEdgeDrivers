...
function StandardNamespace:new_value(...)
...
function StandardNamespace:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function StandardNamespace:subscribe(device, endpoint_id)
...
function StandardNamespace:set_parent_cluster(cluster)
...
function StandardNamespace:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function StandardNamespace:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(StandardNamespace, {__call = StandardNamespace.new_value})
