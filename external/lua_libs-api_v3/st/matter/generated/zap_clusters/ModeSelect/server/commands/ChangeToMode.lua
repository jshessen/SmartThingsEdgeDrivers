...
-----------------------------------------------------------
-- ModeSelect command ChangeToMode
-----------------------------------------------------------
...
--- @field public NAME string "ChangeToMode" the name of this command
--- @field public new_mode data_types.Uint8
local ChangeToMode = {}
...
---
--- @param self ChangeToMode the template class for this command
--- @param device st.matter.Device the device to build this message to
--- @param new_mode st.matter.data_types.Uint8
