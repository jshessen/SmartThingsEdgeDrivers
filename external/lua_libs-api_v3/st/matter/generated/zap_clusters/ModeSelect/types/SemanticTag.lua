...
---
--- @field public mfg_code st.matter.data_types.Uint16
--- @field public value st.matter.data_types.Uint16
local SemanticTag = {}
local new_mt = StructureABC.new_mt({NAME = "SemanticTag", ID = data_types.name_to_id_map["Structure"]})

SemanticTag.field_defs = {
  {
...
SemanticTag.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
SemanticTag.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = SemanticTag.init
new_mt.__index.serialize = SemanticTag.serialize

SemanticTag.augment_type = function(self, val)
  local elems = {}
...
setmetatable(SemanticTag, new_mt)
