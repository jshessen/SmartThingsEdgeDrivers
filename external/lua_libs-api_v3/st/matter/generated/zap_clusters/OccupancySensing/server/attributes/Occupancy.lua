...
--- @class st.matter.clusters.OccupancySensing.Occupancy
--- @alias Occupancy
---
...
function Occupancy:read(device, endpoint_id)
...
--- Reporting policy: Occupancy => true => suggested
...
--- @param endpoint_id number|nil
--- @return any
function Occupancy:subscribe(device, endpoint_id)
...
function Occupancy:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Occupancy:deserialize(tlv_buf)
