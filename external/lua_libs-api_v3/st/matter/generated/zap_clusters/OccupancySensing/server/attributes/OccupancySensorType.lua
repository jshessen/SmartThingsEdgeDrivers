...
--- @class st.matter.clusters.OccupancySensing.OccupancySensorType
...
function OccupancySensorType:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function OccupancySensorType:subscribe(device, endpoint_id)
...
function OccupancySensorType:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OccupancySensorType:deserialize(tlv_buf)
