...
--- @class st.matter.clusters.OccupancySensing.OccupancySensorTypeBitmap
...
function OccupancySensorTypeBitmap:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function OccupancySensorTypeBitmap:subscribe(device, endpoint_id)
...
function OccupancySensorTypeBitmap:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OccupancySensorTypeBitmap:deserialize(tlv_buf)
