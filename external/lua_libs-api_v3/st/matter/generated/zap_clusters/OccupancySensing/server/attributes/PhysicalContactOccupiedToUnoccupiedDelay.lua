...
--- @class st.matter.clusters.OccupancySensing.PhysicalContactOccupiedToUnoccupiedDelay
...
function PhysicalContactOccupiedToUnoccupiedDelay:read(device, endpoint_id)
...
function PhysicalContactOccupiedToUnoccupiedDelay:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function PhysicalContactOccupiedToUnoccupiedDelay:subscribe(device, endpoint_id)
...
function PhysicalContactOccupiedToUnoccupiedDelay:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PhysicalContactOccupiedToUnoccupiedDelay:deserialize(tlv_buf)
