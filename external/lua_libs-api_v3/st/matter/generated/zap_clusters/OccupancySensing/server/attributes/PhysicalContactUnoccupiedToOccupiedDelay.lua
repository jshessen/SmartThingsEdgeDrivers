...
--- @class st.matter.clusters.OccupancySensing.PhysicalContactUnoccupiedToOccupiedDelay
...
function PhysicalContactUnoccupiedToOccupiedDelay:read(device, endpoint_id)
...
function PhysicalContactUnoccupiedToOccupiedDelay:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function PhysicalContactUnoccupiedToOccupiedDelay:subscribe(device, endpoint_id)
...
function PhysicalContactUnoccupiedToOccupiedDelay:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PhysicalContactUnoccupiedToOccupiedDelay:deserialize(tlv_buf)
