...
--- @class st.matter.clusters.OccupancySensing.PhysicalContactUnoccupiedToOccupiedThreshold
...
function PhysicalContactUnoccupiedToOccupiedThreshold:read(device, endpoint_id)
...
function PhysicalContactUnoccupiedToOccupiedThreshold:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function PhysicalContactUnoccupiedToOccupiedThreshold:subscribe(device, endpoint_id)
...
function PhysicalContactUnoccupiedToOccupiedThreshold:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PhysicalContactUnoccupiedToOccupiedThreshold:deserialize(tlv_buf)
