...
--- @class st.matter.clusters.OccupancySensing.PirOccupiedToUnoccupiedDelay
...
function PirOccupiedToUnoccupiedDelay:read(device, endpoint_id)
...
function PirOccupiedToUnoccupiedDelay:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function PirOccupiedToUnoccupiedDelay:subscribe(device, endpoint_id)
...
function PirOccupiedToUnoccupiedDelay:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PirOccupiedToUnoccupiedDelay:deserialize(tlv_buf)
