...
--- @class st.matter.clusters.OccupancySensing.PirUnoccupiedToOccupiedDelay
...
function PirUnoccupiedToOccupiedDelay:read(device, endpoint_id)
...
function PirUnoccupiedToOccupiedDelay:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function PirUnoccupiedToOccupiedDelay:subscribe(device, endpoint_id)
...
function PirUnoccupiedToOccupiedDelay:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PirUnoccupiedToOccupiedDelay:deserialize(tlv_buf)
