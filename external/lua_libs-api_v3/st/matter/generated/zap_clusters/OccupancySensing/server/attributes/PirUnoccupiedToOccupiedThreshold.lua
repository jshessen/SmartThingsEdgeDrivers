...
--- @class st.matter.clusters.OccupancySensing.PirUnoccupiedToOccupiedThreshold
...
function PirUnoccupiedToOccupiedThreshold:read(device, endpoint_id)
...
function PirUnoccupiedToOccupiedThreshold:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function PirUnoccupiedToOccupiedThreshold:subscribe(device, endpoint_id)
...
function PirUnoccupiedToOccupiedThreshold:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PirUnoccupiedToOccupiedThreshold:deserialize(tlv_buf)
