...
--- @class st.matter.clusters.OccupancySensing.UltrasonicOccupiedToUnoccupiedDelay
...
function UltrasonicOccupiedToUnoccupiedDelay:read(device, endpoint_id)
...
function UltrasonicOccupiedToUnoccupiedDelay:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function UltrasonicOccupiedToUnoccupiedDelay:subscribe(device, endpoint_id)
...
function UltrasonicOccupiedToUnoccupiedDelay:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function UltrasonicOccupiedToUnoccupiedDelay:deserialize(tlv_buf)
