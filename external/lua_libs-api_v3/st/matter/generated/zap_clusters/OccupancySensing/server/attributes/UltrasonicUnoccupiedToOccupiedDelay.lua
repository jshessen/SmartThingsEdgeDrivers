...
--- @class st.matter.clusters.OccupancySensing.UltrasonicUnoccupiedToOccupiedDelay
...
function UltrasonicUnoccupiedToOccupiedDelay:read(device, endpoint_id)
...
function UltrasonicUnoccupiedToOccupiedDelay:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function UltrasonicUnoccupiedToOccupiedDelay:subscribe(device, endpoint_id)
...
function UltrasonicUnoccupiedToOccupiedDelay:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function UltrasonicUnoccupiedToOccupiedDelay:deserialize(tlv_buf)
