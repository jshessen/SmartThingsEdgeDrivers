...
--- @class st.matter.clusters.OccupancySensing.UltrasonicUnoccupiedToOccupiedThreshold
...
function UltrasonicUnoccupiedToOccupiedThreshold:read(device, endpoint_id)
...
function UltrasonicUnoccupiedToOccupiedThreshold:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function UltrasonicUnoccupiedToOccupiedThreshold:subscribe(device, endpoint_id)
...
function UltrasonicUnoccupiedToOccupiedThreshold:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function UltrasonicUnoccupiedToOccupiedThreshold:deserialize(tlv_buf)
