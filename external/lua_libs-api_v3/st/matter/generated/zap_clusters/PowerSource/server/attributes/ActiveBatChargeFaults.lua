...
function ActiveBatChargeFaults:new_value(...)
...
function ActiveBatChargeFaults:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ActiveBatChargeFaults:subscribe(device, endpoint_id)
...
function ActiveBatChargeFaults:set_parent_cluster(cluster)
...
function ActiveBatChargeFaults:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ActiveBatChargeFaults:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(ActiveBatChargeFaults, {__call = ActiveBatChargeFaults.new_value})
