...
function ActiveBatFaults:new_value(...)
...
function ActiveBatFaults:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ActiveBatFaults:subscribe(device, endpoint_id)
...
function ActiveBatFaults:set_parent_cluster(cluster)
...
function ActiveBatFaults:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ActiveBatFaults:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(ActiveBatFaults, {__call = ActiveBatFaults.new_value})
