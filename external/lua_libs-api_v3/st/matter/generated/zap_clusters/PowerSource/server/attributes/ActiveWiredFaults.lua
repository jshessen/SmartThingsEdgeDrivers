...
function ActiveWiredFaults:new_value(...)
...
function ActiveWiredFaults:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ActiveWiredFaults:subscribe(device, endpoint_id)
...
function ActiveWiredFaults:set_parent_cluster(cluster)
...
function ActiveWiredFaults:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ActiveWiredFaults:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(ActiveWiredFaults, {__call = ActiveWiredFaults.new_value})
