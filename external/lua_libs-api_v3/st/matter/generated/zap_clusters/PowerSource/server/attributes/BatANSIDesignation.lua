...
function BatANSIDesignation:new_value(...)
...
function BatANSIDesignation:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatANSIDesignation:subscribe(device, endpoint_id)
...
function BatANSIDesignation:set_parent_cluster(cluster)
...
function BatANSIDesignation:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatANSIDesignation:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatANSIDesignation, {__call = BatANSIDesignation.new_value})
