...
function BatApprovedChemistry:new_value(...)
...
function BatApprovedChemistry:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatApprovedChemistry:subscribe(device, endpoint_id)
...
function BatApprovedChemistry:set_parent_cluster(cluster)
...
function BatApprovedChemistry:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatApprovedChemistry:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatApprovedChemistry, {__call = BatApprovedChemistry.new_value})
