...
--- @field public NAME string "BatCapacity" the name of this attribute
...
function BatCapacity:new_value(...)
...
function BatCapacity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatCapacity:subscribe(device, endpoint_id)
...
function BatCapacity:set_parent_cluster(cluster)
...
function BatCapacity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatCapacity:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatCapacity, {__call = BatCapacity.new_value})
return BatCapacity
