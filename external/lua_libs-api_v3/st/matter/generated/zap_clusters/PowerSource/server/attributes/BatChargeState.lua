...
--- @field public NAME string "BatChargeState" the name of this attribute
...
BatChargeState.UNKNOWN = 0x00
BatChargeState.IS_CHARGING = 0x01
BatChargeState.IS_AT_FULL_CHARGE = 0x02
BatChargeState.IS_NOT_CHARGING = 0x03

BatChargeState.enum_fields = {
  [BatChargeState.UNKNOWN] = "UNKNOWN",
  [BatChargeState.IS_CHARGING] = "IS_CHARGING",
  [BatChargeState.IS_AT_FULL_CHARGE] = "IS_AT_FULL_CHARGE",
  [BatChargeState.IS_NOT_CHARGING] = "IS_NOT_CHARGING",
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint8 the base data type object to add functionality to
function BatChargeState:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function BatChargeState.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, BatChargeState.enum_fields[value_obj.value])
end
...
function BatChargeState:new_value(...)
...
function BatChargeState:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatChargeState:subscribe(device, endpoint_id)
...
function BatChargeState:set_parent_cluster(cluster)
...
function BatChargeState:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatChargeState:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(BatChargeState, {__call = BatChargeState.new_value})
