...
function BatChargingCurrent:new_value(...)
...
function BatChargingCurrent:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatChargingCurrent:subscribe(device, endpoint_id)
...
function BatChargingCurrent:set_parent_cluster(cluster)
...
function BatChargingCurrent:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatChargingCurrent:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatChargingCurrent, {__call = BatChargingCurrent.new_value})
