...
function BatCommonDesignation:new_value(...)
...
function BatCommonDesignation:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatCommonDesignation:subscribe(device, endpoint_id)
...
function BatCommonDesignation:set_parent_cluster(cluster)
...
function BatCommonDesignation:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatCommonDesignation:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatCommonDesignation, {__call = BatCommonDesignation.new_value})
