...
--- @alias BatFunctionalWhileCharging
---
--- @field public ID number 0x001C the ID of this attribute
--- @field public NAME string "BatFunctionalWhileCharging" the name of this attribute
--- @field public data_type st.matter.data_types.Boolean the data type of this attribute

local BatFunctionalWhileCharging = {
  ID = 0x001C,
...
function BatFunctionalWhileCharging:new_value(...)
...
function BatFunctionalWhileCharging:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatFunctionalWhileCharging:subscribe(device, endpoint_id)
...
function BatFunctionalWhileCharging:set_parent_cluster(cluster)
...
function BatFunctionalWhileCharging:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatFunctionalWhileCharging:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatFunctionalWhileCharging, {__call = BatFunctionalWhileCharging.new_value})
