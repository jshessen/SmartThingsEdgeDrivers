...
function BatIECDesignation:new_value(...)
...
function BatIECDesignation:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatIECDesignation:subscribe(device, endpoint_id)
...
function BatIECDesignation:set_parent_cluster(cluster)
...
function BatIECDesignation:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatIECDesignation:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatIECDesignation, {__call = BatIECDesignation.new_value})
