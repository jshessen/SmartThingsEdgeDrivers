...
function BatPercentRemaining:new_value(...)
...
function BatPercentRemaining:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatPercentRemaining:subscribe(device, endpoint_id)
...
function BatPercentRemaining:set_parent_cluster(cluster)
...
function BatPercentRemaining:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatPercentRemaining:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatPercentRemaining, {__call = BatPercentRemaining.new_value})
