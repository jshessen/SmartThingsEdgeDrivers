...
--- @field public NAME string "BatPresent" the name of this attribute
...
function BatPresent:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatPresent:subscribe(device, endpoint_id)
...
function BatPresent:set_parent_cluster(cluster)
...
function BatPresent:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatPresent:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatPresent, {__call = BatPresent.new_value})
return BatPresent
