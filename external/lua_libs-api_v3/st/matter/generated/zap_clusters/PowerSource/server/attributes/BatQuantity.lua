...
--- @field public NAME string "BatQuantity" the name of this attribute
...
function BatQuantity:new_value(...)
...
function BatQuantity:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatQuantity:subscribe(device, endpoint_id)
...
function BatQuantity:set_parent_cluster(cluster)
...
function BatQuantity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatQuantity:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatQuantity, {__call = BatQuantity.new_value})
return BatQuantity
