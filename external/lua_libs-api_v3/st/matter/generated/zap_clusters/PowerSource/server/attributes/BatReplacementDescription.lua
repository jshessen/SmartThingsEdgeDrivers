...
function BatReplacementDescription:new_value(...)
...
function BatReplacementDescription:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatReplacementDescription:subscribe(device, endpoint_id)
...
function BatReplacementDescription:set_parent_cluster(cluster)
...
function BatReplacementDescription:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatReplacementDescription:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatReplacementDescription, {__call = BatReplacementDescription.new_value})
