...
function BatReplacementNeeded:new_value(...)
...
function BatReplacementNeeded:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatReplacementNeeded:subscribe(device, endpoint_id)
...
function BatReplacementNeeded:set_parent_cluster(cluster)
...
function BatReplacementNeeded:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatReplacementNeeded:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatReplacementNeeded, {__call = BatReplacementNeeded.new_value})
