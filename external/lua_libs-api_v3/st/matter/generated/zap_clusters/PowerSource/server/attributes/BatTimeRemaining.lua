...
function BatTimeRemaining:new_value(...)
...
function BatTimeRemaining:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatTimeRemaining:subscribe(device, endpoint_id)
...
function BatTimeRemaining:set_parent_cluster(cluster)
...
function BatTimeRemaining:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatTimeRemaining:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatTimeRemaining, {__call = BatTimeRemaining.new_value})
