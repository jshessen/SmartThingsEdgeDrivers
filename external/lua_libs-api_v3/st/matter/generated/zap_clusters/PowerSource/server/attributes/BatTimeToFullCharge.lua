...
function BatTimeToFullCharge:new_value(...)
...
function BatTimeToFullCharge:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatTimeToFullCharge:subscribe(device, endpoint_id)
...
function BatTimeToFullCharge:set_parent_cluster(cluster)
...
function BatTimeToFullCharge:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatTimeToFullCharge:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatTimeToFullCharge, {__call = BatTimeToFullCharge.new_value})
