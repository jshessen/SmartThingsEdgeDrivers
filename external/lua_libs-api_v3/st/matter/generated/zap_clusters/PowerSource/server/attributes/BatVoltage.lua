...
--- @field public NAME string "BatVoltage" the name of this attribute
...
function BatVoltage:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function BatVoltage:subscribe(device, endpoint_id)
...
function BatVoltage:set_parent_cluster(cluster)
...
function BatVoltage:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function BatVoltage:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(BatVoltage, {__call = BatVoltage.new_value})
return BatVoltage
