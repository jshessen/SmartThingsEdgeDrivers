...
--- @field public NAME string "Order" the name of this attribute
...
function Order:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function Order:subscribe(device, endpoint_id)
...
function Order:set_parent_cluster(cluster)
...
function Order:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function Order:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(Order, {__call = Order.new_value})
return Order
