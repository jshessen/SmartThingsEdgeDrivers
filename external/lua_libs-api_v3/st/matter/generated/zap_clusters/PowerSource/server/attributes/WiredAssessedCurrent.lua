...
function WiredAssessedCurrent:new_value(...)
...
function WiredAssessedCurrent:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function WiredAssessedCurrent:subscribe(device, endpoint_id)
...
function WiredAssessedCurrent:set_parent_cluster(cluster)
...
function WiredAssessedCurrent:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WiredAssessedCurrent:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(WiredAssessedCurrent, {__call = WiredAssessedCurrent.new_value})
