...
--- @alias WiredAssessedInputFrequency
---
--- @field public ID number 0x0004 the ID of this attribute
--- @field public NAME string "WiredAssessedInputFrequency" the name of this attribute
--- @field public data_type st.matter.data_types.Uint16 the data type of this attribute

local WiredAssessedInputFrequency = {
  ID = 0x0004,
...
function WiredAssessedInputFrequency:new_value(...)
...
function WiredAssessedInputFrequency:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function WiredAssessedInputFrequency:subscribe(device, endpoint_id)
...
function WiredAssessedInputFrequency:set_parent_cluster(cluster)
...
function WiredAssessedInputFrequency:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WiredAssessedInputFrequency:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(WiredAssessedInputFrequency, {__call = WiredAssessedInputFrequency.new_value})
