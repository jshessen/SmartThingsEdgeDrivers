...
--- @alias WiredAssessedInputVoltage
---
--- @field public ID number 0x0003 the ID of this attribute
--- @field public NAME string "WiredAssessedInputVoltage" the name of this attribute
--- @field public data_type st.matter.data_types.Uint32 the data type of this attribute

local WiredAssessedInputVoltage = {
  ID = 0x0003,
...
function WiredAssessedInputVoltage:new_value(...)
...
function WiredAssessedInputVoltage:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function WiredAssessedInputVoltage:subscribe(device, endpoint_id)
...
function WiredAssessedInputVoltage:set_parent_cluster(cluster)
...
function WiredAssessedInputVoltage:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WiredAssessedInputVoltage:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(WiredAssessedInputVoltage, {__call = WiredAssessedInputVoltage.new_value})
