...
function WiredMaximumCurrent:new_value(...)
...
function WiredMaximumCurrent:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function WiredMaximumCurrent:subscribe(device, endpoint_id)
...
function WiredMaximumCurrent:set_parent_cluster(cluster)
...
function WiredMaximumCurrent:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WiredMaximumCurrent:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(WiredMaximumCurrent, {__call = WiredMaximumCurrent.new_value})
