...
function WiredNominalVoltage:new_value(...)
...
function WiredNominalVoltage:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function WiredNominalVoltage:subscribe(device, endpoint_id)
...
function WiredNominalVoltage:set_parent_cluster(cluster)
...
function WiredNominalVoltage:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WiredNominalVoltage:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(WiredNominalVoltage, {__call = WiredNominalVoltage.new_value})
