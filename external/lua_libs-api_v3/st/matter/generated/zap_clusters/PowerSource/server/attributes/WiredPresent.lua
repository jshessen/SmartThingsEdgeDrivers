...
--- @field public NAME string "WiredPresent" the name of this attribute
...
function WiredPresent:new_value(...)
...
function WiredPresent:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function WiredPresent:subscribe(device, endpoint_id)
...
function WiredPresent:set_parent_cluster(cluster)
...
function WiredPresent:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function WiredPresent:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(WiredPresent, {__call = WiredPresent.new_value})
return WiredPresent
