...
local BatChargeFault = require "st.matter.generated.zap_clusters.PowerSource.types.BatChargeFault"
local BatChargeFault = require "st.matter.generated.zap_clusters.PowerSource.types.BatChargeFault"
--- @alias BatChargeFaultChangeType
--- @class st.matter.clusters.PowerSource.types.BatChargeFaultChangeType: st.matter.data_types.Structure
---
--- @field public current BatChargeFault
--- @field public previous BatChargeFault
local BatChargeFaultChangeType = {}
local new_mt = StructureABC.new_mt({NAME = "BatChargeFaultChangeType", ID = data_types.name_to_id_map["Structure"]})

BatChargeFaultChangeType.field_defs = {
  {
    data_type = BatChargeFault,
    field_id = 0,
    name = "current",
...
BatChargeFaultChangeType.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
BatChargeFaultChangeType.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = BatChargeFaultChangeType.init
new_mt.__index.serialize = BatChargeFaultChangeType.serialize

BatChargeFaultChangeType.augment_type = function(self, val)
  local elems = {}
...
setmetatable(BatChargeFaultChangeType, new_mt)

return BatChargeFaultChangeType
