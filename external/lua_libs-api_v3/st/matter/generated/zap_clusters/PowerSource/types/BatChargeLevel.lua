...
local new_mt = UintABC.new_mt({NAME = "BatChargeLevel", ID = data_types.name_to_id_map["Uint8"]}, 1)
...
BatChargeLevel.augment_type = function(cls, val)
  setmetatable(val, new_mt)
end

setmetatable(BatChargeLevel, new_mt)
