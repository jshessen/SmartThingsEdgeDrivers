...
local BatFault = require "st.matter.generated.zap_clusters.PowerSource.types.BatFault"
local BatFault = require "st.matter.generated.zap_clusters.PowerSource.types.BatFault"
--- @alias BatFaultChangeType
--- @class st.matter.clusters.PowerSource.types.BatFaultChangeType: st.matter.data_types.Structure
---
--- @field public current BatFault
--- @field public previous BatFault
local BatFaultChangeType = {}
local new_mt = StructureABC.new_mt({NAME = "BatFaultChangeType", ID = data_types.name_to_id_map["Structure"]})

BatFaultChangeType.field_defs = {
  {
    data_type = BatFault,
    field_id = 0,
    name = "current",
...
BatFaultChangeType.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
BatFaultChangeType.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = BatFaultChangeType.init
new_mt.__index.serialize = BatFaultChangeType.serialize

BatFaultChangeType.augment_type = function(self, val)
  local elems = {}
...
setmetatable(BatFaultChangeType, new_mt)

return BatFaultChangeType
