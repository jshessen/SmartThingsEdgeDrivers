...
local new_mt = UintABC.new_mt({NAME = "WiredCurrentType", ID = data_types.name_to_id_map["Uint8"]}, 1)
...
new_mt.__index.AC  = 0x00
new_mt.__index.DC  = 0x01

WiredCurrentType.augment_type = function(cls, val)
  setmetatable(val, new_mt)
end

setmetatable(WiredCurrentType, new_mt)
