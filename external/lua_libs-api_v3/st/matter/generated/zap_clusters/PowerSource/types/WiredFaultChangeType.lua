...
local WiredFault = require "st.matter.generated.zap_clusters.PowerSource.types.WiredFault"
local WiredFault = require "st.matter.generated.zap_clusters.PowerSource.types.WiredFault"
--- @alias WiredFaultChangeType
--- @class st.matter.clusters.PowerSource.types.WiredFaultChangeType: st.matter.data_types.Structure
---
--- @field public current WiredFault
--- @field public previous WiredFault
local WiredFaultChangeType = {}
local new_mt = StructureABC.new_mt({NAME = "WiredFaultChangeType", ID = data_types.name_to_id_map["Structure"]})

WiredFaultChangeType.field_defs = {
  {
    data_type = WiredFault,
    field_id = 0,
    name = "current",
...
WiredFaultChangeType.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
WiredFaultChangeType.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = WiredFaultChangeType.init
new_mt.__index.serialize = WiredFaultChangeType.serialize

WiredFaultChangeType.augment_type = function(self, val)
  local elems = {}
...
setmetatable(WiredFaultChangeType, new_mt)

return WiredFaultChangeType
