...
--- @field public NAME string "CurrentPosition" the name of this attribute
...
function CurrentPosition:new_value(...)
...
function CurrentPosition:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentPosition:subscribe(device, endpoint_id)
...
function CurrentPosition:set_parent_cluster(cluster)
...
function CurrentPosition:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentPosition:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(CurrentPosition, {__call = CurrentPosition.new_value})
