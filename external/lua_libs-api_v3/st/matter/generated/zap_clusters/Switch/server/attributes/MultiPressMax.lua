...
--- @field public NAME string "MultiPressMax" the name of this attribute
...
function MultiPressMax:new_value(...)
...
function MultiPressMax:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function MultiPressMax:subscribe(device, endpoint_id)
...
function MultiPressMax:set_parent_cluster(cluster)
...
function MultiPressMax:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MultiPressMax:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(MultiPressMax, {__call = MultiPressMax.new_value})
