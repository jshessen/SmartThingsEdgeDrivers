...
--- @field public NAME string "NumberOfPositions" the name of this attribute
--- @field public data_type st.matter.data_types.Uint8 the data type of this attribute

local NumberOfPositions = {
  ID = 0x0000,
...
function NumberOfPositions:new_value(...)
...
function NumberOfPositions:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfPositions:subscribe(device, endpoint_id)
...
function NumberOfPositions:set_parent_cluster(cluster)
...
function NumberOfPositions:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfPositions:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(NumberOfPositions, {__call = NumberOfPositions.new_value})
