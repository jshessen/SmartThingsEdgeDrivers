...
--- @field public NAME string "InitialPress" the name of this event
...
function InitialPress:augment_type(base_type_obj)
  local elems = {}
...
function InitialPress:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function InitialPress:subscribe(device, endpoint_id)
...
function InitialPress:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "InitialPressEventData", ID = 0x15}))
...
function InitialPress:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function InitialPress:set_parent_cluster(cluster)
