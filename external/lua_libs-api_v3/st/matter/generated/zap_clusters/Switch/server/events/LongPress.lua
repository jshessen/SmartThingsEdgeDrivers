...
--- @alias LongPress
---
--- @field public ID number 0x0002 the ID of this event
--- @field public NAME string "LongPress" the name of this event
...
function LongPress:augment_type(base_type_obj)
  local elems = {}
...
function LongPress:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function LongPress:subscribe(device, endpoint_id)
...
function LongPress:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "LongPressEventData", ID = 0x15}))
...
function LongPress:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function LongPress:set_parent_cluster(cluster)
