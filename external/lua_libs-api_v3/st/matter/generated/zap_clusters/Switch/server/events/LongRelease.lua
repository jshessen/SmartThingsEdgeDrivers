...
--- @field public NAME string "LongRelease" the name of this event
--- @field public previous_position data_types.Uint8
local LongRelease = {
  ID = 0x0004,
  NAME = "LongRelease",
...
function LongRelease:augment_type(base_type_obj)
  local elems = {}
...
function LongRelease:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function LongRelease:subscribe(device, endpoint_id)
...
function LongRelease:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "LongReleaseEventData", ID = 0x15}))
...
function LongRelease:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function LongRelease:set_parent_cluster(cluster)
