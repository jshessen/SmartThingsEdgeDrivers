...
--- @alias MultiPressComplete
---
--- @field public ID number 0x0006 the ID of this event
--- @field public NAME string "MultiPressComplete" the name of this event
--- @field public new_position data_types.Uint8
--- @field public total_number_of_presses_counted data_types.Uint8
local MultiPressComplete = {
  ID = 0x0006,
  NAME = "MultiPressComplete",
  base_type = data_types.Structure,
}

MultiPressComplete.field_defs = {
  {
  ...
  },
  {
    ...
    field_id = 1,
    is_array = false,
    name = "total_number_of_presses_counted",
    is_nullable = false,
    is_optional = false,
  },
}
...
function MultiPressComplete:augment_type(base_type_obj)
  local elems = {}
...
function MultiPressComplete:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function MultiPressComplete:subscribe(device, endpoint_id)
...
function MultiPressComplete:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "MultiPressCompleteEventData", ID = 0x15}))
...
function MultiPressComplete:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function MultiPressComplete:set_parent_cluster(cluster)
