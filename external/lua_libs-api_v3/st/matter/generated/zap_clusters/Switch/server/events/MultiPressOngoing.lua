...
--- @alias MultiPressOngoing
---
--- @field public ID number 0x0005 the ID of this event
--- @field public NAME string "MultiPressOngoing" the name of this event
--- @field public new_position data_types.Uint8
--- @field public current_number_of_presses_counted data_types.Uint8
local MultiPressOngoing = {
  ID = 0x0005,
  NAME = "MultiPressOngoing",
  base_type = data_types.Structure,
}

MultiPressOngoing.field_defs = {
  {
  ...
  },
  {
    ...
    field_id = 1,
    is_array = false,
    name = "current_number_of_presses_counted",
    is_nullable = false,
    is_optional = false,
  },
}
...
function MultiPressOngoing:augment_type(base_type_obj)
  local elems = {}
...
function MultiPressOngoing:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function MultiPressOngoing:subscribe(device, endpoint_id)
...
function MultiPressOngoing:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "MultiPressOngoingEventData", ID = 0x15}))
...
function MultiPressOngoing:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function MultiPressOngoing:set_parent_cluster(cluster)
