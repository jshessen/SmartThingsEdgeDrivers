...
--- @field public NAME string "SwitchLatched" the name of this event
...
function SwitchLatched:augment_type(base_type_obj)
  local elems = {}
...
function SwitchLatched:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return st.matter.interaction_model.InteractionRequest
function SwitchLatched:subscribe(device, endpoint_id)
...
function SwitchLatched:build_test_event_report(
  device,
  endpoint_id,
  fields,
  status
  ...
  data.elements = {}
  data.num_elements = 0
  setmetatable(data, StructureABC.new_mt({NAME = "SwitchLatchedEventData", ID = 0x15}))
...
function SwitchLatched:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

function SwitchLatched:set_parent_cluster(cluster)
