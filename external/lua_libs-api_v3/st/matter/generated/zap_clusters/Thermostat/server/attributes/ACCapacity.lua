...
function ACCapacity:read(device, endpoint_id)
...
function ACCapacity:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ACCapacity:subscribe(device, endpoint_id)
...
function ACCapacity:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ACCapacity:deserialize(tlv_buf)
