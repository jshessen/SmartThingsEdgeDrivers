...
function ACCapacityformat:read(device, endpoint_id)
...
function ACCapacityformat:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ACCapacityformat:subscribe(device, endpoint_id)
...
function ACCapacityformat:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ACCapacityformat:deserialize(tlv_buf)
