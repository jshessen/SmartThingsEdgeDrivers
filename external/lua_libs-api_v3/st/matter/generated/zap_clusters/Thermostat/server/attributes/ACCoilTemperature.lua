...
function ACCoilTemperature:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ACCoilTemperature:subscribe(device, endpoint_id)
...
function ACCoilTemperature:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ACCoilTemperature:deserialize(tlv_buf)
