...
function ACCompressorType:read(device, endpoint_id)
...
function ACCompressorType:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ACCompressorType:subscribe(device, endpoint_id)
...
function ACCompressorType:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ACCompressorType:deserialize(tlv_buf)
