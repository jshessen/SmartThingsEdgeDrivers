...
function ACErrorCode:read(device, endpoint_id)
...
function ACErrorCode:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ACErrorCode:subscribe(device, endpoint_id)
...
function ACErrorCode:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ACErrorCode:deserialize(tlv_buf)
