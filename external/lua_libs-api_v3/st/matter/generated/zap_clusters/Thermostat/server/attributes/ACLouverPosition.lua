...
function ACLouverPosition:read(device, endpoint_id)
...
function ACLouverPosition:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ACLouverPosition:subscribe(device, endpoint_id)
...
function ACLouverPosition:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ACLouverPosition:deserialize(tlv_buf)
