...
function ACRefrigerantType:read(device, endpoint_id)
...
function ACRefrigerantType:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ACRefrigerantType:subscribe(device, endpoint_id)
...
function ACRefrigerantType:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ACRefrigerantType:deserialize(tlv_buf)
