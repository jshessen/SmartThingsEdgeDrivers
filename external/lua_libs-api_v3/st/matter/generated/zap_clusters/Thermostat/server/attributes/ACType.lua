...
function ACType:read(device, endpoint_id)
...
function ACType:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ACType:subscribe(device, endpoint_id)
...
function ACType:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ACType:deserialize(tlv_buf)
