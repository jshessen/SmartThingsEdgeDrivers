...
function AbsMaxCoolSetpointLimit:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AbsMaxCoolSetpointLimit:subscribe(device, endpoint_id)
...
function AbsMaxCoolSetpointLimit:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AbsMaxCoolSetpointLimit:deserialize(tlv_buf)
