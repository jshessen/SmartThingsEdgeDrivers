...
function AbsMaxHeatSetpointLimit:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AbsMaxHeatSetpointLimit:subscribe(device, endpoint_id)
...
function AbsMaxHeatSetpointLimit:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AbsMaxHeatSetpointLimit:deserialize(tlv_buf)
