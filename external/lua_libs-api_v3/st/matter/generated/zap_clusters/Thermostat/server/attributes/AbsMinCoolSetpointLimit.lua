...
function AbsMinCoolSetpointLimit:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AbsMinCoolSetpointLimit:subscribe(device, endpoint_id)
...
function AbsMinCoolSetpointLimit:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AbsMinCoolSetpointLimit:deserialize(tlv_buf)
