...
function AbsMinHeatSetpointLimit:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function AbsMinHeatSetpointLimit:subscribe(device, endpoint_id)
...
function AbsMinHeatSetpointLimit:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function AbsMinHeatSetpointLimit:deserialize(tlv_buf)
