...
function EmergencyHeatDelta:read(device, endpoint_id)
...
function EmergencyHeatDelta:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function EmergencyHeatDelta:subscribe(device, endpoint_id)
...
function EmergencyHeatDelta:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function EmergencyHeatDelta:deserialize(tlv_buf)
