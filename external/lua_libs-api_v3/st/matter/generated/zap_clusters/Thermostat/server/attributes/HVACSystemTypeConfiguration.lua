...
function HVACSystemTypeConfiguration:read(device, endpoint_id)
...
function HVACSystemTypeConfiguration:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function HVACSystemTypeConfiguration:subscribe(device, endpoint_id)
...
function HVACSystemTypeConfiguration:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function HVACSystemTypeConfiguration:deserialize(tlv_buf)
