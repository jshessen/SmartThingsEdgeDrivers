...
function LocalTemperature:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function LocalTemperature:subscribe(device, endpoint_id)
...
function LocalTemperature:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LocalTemperature:deserialize(tlv_buf)
