...
function LocalTemperatureCalibration:read(device, endpoint_id)
...
--- @param device st.matter.Device
--- @param endpoint_id number|nil
--- @param value st.matter.data_types.Int8
--- @return st.matter.data_types.Int8 the value to write
function LocalTemperatureCalibration:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function LocalTemperatureCalibration:subscribe(device, endpoint_id)
...
function LocalTemperatureCalibration:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function LocalTemperatureCalibration:deserialize(tlv_buf)
