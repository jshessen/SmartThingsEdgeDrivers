...
function MaxCoolSetpointLimit:read(device, endpoint_id)
...
function MaxCoolSetpointLimit:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function MaxCoolSetpointLimit:subscribe(device, endpoint_id)
...
function MaxCoolSetpointLimit:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxCoolSetpointLimit:deserialize(tlv_buf)
