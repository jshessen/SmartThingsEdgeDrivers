...
function MaxHeatSetpointLimit:read(device, endpoint_id)
...
function MaxHeatSetpointLimit:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function MaxHeatSetpointLimit:subscribe(device, endpoint_id)
...
function MaxHeatSetpointLimit:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MaxHeatSetpointLimit:deserialize(tlv_buf)
