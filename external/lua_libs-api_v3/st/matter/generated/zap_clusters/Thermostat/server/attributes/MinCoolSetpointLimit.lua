...
function MinCoolSetpointLimit:read(device, endpoint_id)
...
function MinCoolSetpointLimit:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function MinCoolSetpointLimit:subscribe(device, endpoint_id)
...
function MinCoolSetpointLimit:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinCoolSetpointLimit:deserialize(tlv_buf)
