...
function MinHeatSetpointLimit:read(device, endpoint_id)
...
function MinHeatSetpointLimit:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function MinHeatSetpointLimit:subscribe(device, endpoint_id)
...
function MinHeatSetpointLimit:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinHeatSetpointLimit:deserialize(tlv_buf)
