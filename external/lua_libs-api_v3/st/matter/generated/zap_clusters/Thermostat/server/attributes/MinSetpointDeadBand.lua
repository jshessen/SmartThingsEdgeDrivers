...
function MinSetpointDeadBand:read(device, endpoint_id)
...
function MinSetpointDeadBand:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function MinSetpointDeadBand:subscribe(device, endpoint_id)
...
function MinSetpointDeadBand:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function MinSetpointDeadBand:deserialize(tlv_buf)
