...
function NumberOfDailyTransitions:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfDailyTransitions:subscribe(device, endpoint_id)
...
function NumberOfDailyTransitions:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfDailyTransitions:deserialize(tlv_buf)
