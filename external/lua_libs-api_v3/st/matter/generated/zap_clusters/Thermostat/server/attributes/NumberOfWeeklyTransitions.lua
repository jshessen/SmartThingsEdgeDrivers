...
function NumberOfWeeklyTransitions:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfWeeklyTransitions:subscribe(device, endpoint_id)
...
function NumberOfWeeklyTransitions:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfWeeklyTransitions:deserialize(tlv_buf)
