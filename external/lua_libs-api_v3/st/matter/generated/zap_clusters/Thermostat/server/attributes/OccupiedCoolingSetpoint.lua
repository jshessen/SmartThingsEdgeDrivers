...
function OccupiedCoolingSetpoint:read(device, endpoint_id)
...
function OccupiedCoolingSetpoint:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function OccupiedCoolingSetpoint:subscribe(device, endpoint_id)
...
function OccupiedCoolingSetpoint:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OccupiedCoolingSetpoint:deserialize(tlv_buf)
