...
function OccupiedHeatingSetpoint:read(device, endpoint_id)
...
function OccupiedHeatingSetpoint:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function OccupiedHeatingSetpoint:subscribe(device, endpoint_id)
...
function OccupiedHeatingSetpoint:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OccupiedHeatingSetpoint:deserialize(tlv_buf)
