...
function OccupiedSetback:read(device, endpoint_id)
...
function OccupiedSetback:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function OccupiedSetback:subscribe(device, endpoint_id)
...
function OccupiedSetback:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OccupiedSetback:deserialize(tlv_buf)
