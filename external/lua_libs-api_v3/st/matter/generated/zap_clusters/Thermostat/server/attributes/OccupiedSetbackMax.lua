...
function OccupiedSetbackMax:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function OccupiedSetbackMax:subscribe(device, endpoint_id)
...
function OccupiedSetbackMax:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OccupiedSetbackMax:deserialize(tlv_buf)
