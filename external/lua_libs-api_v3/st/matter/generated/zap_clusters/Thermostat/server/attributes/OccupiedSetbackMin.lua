...
function OccupiedSetbackMin:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function OccupiedSetbackMin:subscribe(device, endpoint_id)
...
function OccupiedSetbackMin:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OccupiedSetbackMin:deserialize(tlv_buf)
