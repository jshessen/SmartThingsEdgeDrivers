...
function OutdoorTemperature:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function OutdoorTemperature:subscribe(device, endpoint_id)
...
function OutdoorTemperature:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OutdoorTemperature:deserialize(tlv_buf)
