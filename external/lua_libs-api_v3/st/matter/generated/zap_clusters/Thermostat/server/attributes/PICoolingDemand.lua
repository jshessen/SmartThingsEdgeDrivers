...
function PICoolingDemand:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PICoolingDemand:subscribe(device, endpoint_id)
...
function PICoolingDemand:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PICoolingDemand:deserialize(tlv_buf)
