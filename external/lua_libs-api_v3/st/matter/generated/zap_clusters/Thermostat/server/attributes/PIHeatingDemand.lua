...
function PIHeatingDemand:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PIHeatingDemand:subscribe(device, endpoint_id)
...
function PIHeatingDemand:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PIHeatingDemand:deserialize(tlv_buf)
