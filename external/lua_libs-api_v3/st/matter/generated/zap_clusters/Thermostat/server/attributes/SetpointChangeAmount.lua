...
function SetpointChangeAmount:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SetpointChangeAmount:subscribe(device, endpoint_id)
...
function SetpointChangeAmount:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SetpointChangeAmount:deserialize(tlv_buf)
