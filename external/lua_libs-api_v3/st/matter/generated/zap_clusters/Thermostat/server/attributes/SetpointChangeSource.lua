...
function SetpointChangeSource:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SetpointChangeSource:subscribe(device, endpoint_id)
...
function SetpointChangeSource:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SetpointChangeSource:deserialize(tlv_buf)
