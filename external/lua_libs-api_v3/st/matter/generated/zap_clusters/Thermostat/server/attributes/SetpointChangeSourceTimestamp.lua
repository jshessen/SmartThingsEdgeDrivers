...
function SetpointChangeSourceTimestamp:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SetpointChangeSourceTimestamp:subscribe(device, endpoint_id)
...
function SetpointChangeSourceTimestamp:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SetpointChangeSourceTimestamp:deserialize(tlv_buf)
