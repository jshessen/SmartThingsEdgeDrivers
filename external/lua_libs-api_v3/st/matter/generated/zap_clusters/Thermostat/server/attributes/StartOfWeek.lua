...
function StartOfWeek:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function StartOfWeek:subscribe(device, endpoint_id)
...
function StartOfWeek:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function StartOfWeek:deserialize(tlv_buf)
