...
function SystemMode:read(device, endpoint_id)
...
function SystemMode:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function SystemMode:subscribe(device, endpoint_id)
...
function SystemMode:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SystemMode:deserialize(tlv_buf)
