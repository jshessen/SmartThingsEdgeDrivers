...
function TemperatureSetpointHold:read(device, endpoint_id)
...
function TemperatureSetpointHold:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function TemperatureSetpointHold:subscribe(device, endpoint_id)
...
function TemperatureSetpointHold:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function TemperatureSetpointHold:deserialize(tlv_buf)
