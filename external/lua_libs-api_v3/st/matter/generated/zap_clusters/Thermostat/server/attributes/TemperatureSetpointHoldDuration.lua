...
function TemperatureSetpointHoldDuration:read(device, endpoint_id)
...
function TemperatureSetpointHoldDuration:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function TemperatureSetpointHoldDuration:subscribe(device, endpoint_id)
...
function TemperatureSetpointHoldDuration:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function TemperatureSetpointHoldDuration:deserialize(tlv_buf)
