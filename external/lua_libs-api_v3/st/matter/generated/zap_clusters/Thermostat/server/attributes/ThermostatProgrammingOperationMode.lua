...
function ThermostatProgrammingOperationMode:read(device, endpoint_id)
...
function ThermostatProgrammingOperationMode:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function ThermostatProgrammingOperationMode:subscribe(device, endpoint_id)
...
function ThermostatProgrammingOperationMode:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ThermostatProgrammingOperationMode:deserialize(tlv_buf)
