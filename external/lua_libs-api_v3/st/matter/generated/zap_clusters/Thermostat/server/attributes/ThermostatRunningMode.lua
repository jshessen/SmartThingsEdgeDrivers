...
function ThermostatRunningMode:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ThermostatRunningMode:subscribe(device, endpoint_id)
...
function ThermostatRunningMode:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ThermostatRunningMode:deserialize(tlv_buf)
