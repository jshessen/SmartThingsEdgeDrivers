...
function ThermostatRunningState:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ThermostatRunningState:subscribe(device, endpoint_id)
...
function ThermostatRunningState:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ThermostatRunningState:deserialize(tlv_buf)
