...
function UnoccupiedHeatingSetpoint:read(device, endpoint_id)
...
function UnoccupiedHeatingSetpoint:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function UnoccupiedHeatingSetpoint:subscribe(device, endpoint_id)
...
function UnoccupiedHeatingSetpoint:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function UnoccupiedHeatingSetpoint:deserialize(tlv_buf)
