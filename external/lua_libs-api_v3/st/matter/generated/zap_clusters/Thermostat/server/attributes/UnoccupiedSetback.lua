...
function UnoccupiedSetback:read(device, endpoint_id)
...
function UnoccupiedSetback:write(device, endpoint_id, value)
...
--- @param endpoint_id number|nil
--- @return any
function UnoccupiedSetback:subscribe(device, endpoint_id)
...
function UnoccupiedSetback:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function UnoccupiedSetback:deserialize(tlv_buf)
