...
function UnoccupiedSetbackMax:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function UnoccupiedSetbackMax:subscribe(device, endpoint_id)
...
function UnoccupiedSetbackMax:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function UnoccupiedSetbackMax:deserialize(tlv_buf)
