...
function UnoccupiedSetbackMin:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function UnoccupiedSetbackMin:subscribe(device, endpoint_id)
...
function UnoccupiedSetbackMin:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function UnoccupiedSetbackMin:deserialize(tlv_buf)
