...
ClearWeeklySchedule.ID = 0x0003
ClearWeeklySchedule.field_defs = {
}
...
function ClearWeeklySchedule:build_test_command_response(device, endpoint_id, status)
...
function ClearWeeklySchedule:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function ClearWeeklySchedule:augment_type(base_type_obj)
  local elems = {}
...
function ClearWeeklySchedule:deserialize(tlv_buf)
