...
--- @alias ThermostatScheduleTransition
--- @class st.matter.clusters.Thermostat.types.ThermostatScheduleTransition: st.matter.data_types.Structure
---
--- @field public transition_time st.matter.data_types.Uint16
--- @field public heat_setpoint st.matter.data_types.Int16
--- @field public cool_setpoint st.matter.data_types.Int16
local ThermostatScheduleTransition = {}
local new_mt = StructureABC.new_mt({NAME = "ThermostatScheduleTransition", ID = data_types.name_to_id_map["Structure"]})

ThermostatScheduleTransition.field_defs = {
  {
...
ThermostatScheduleTransition.init = function(cls, tbl)
    local o = {}
    o.elements = {}
    o.num_elements = 0
...
ThermostatScheduleTransition.serialize = function(self, buf, include_control, tag)
  return data_types['Structure'].serialize(self.elements, buf, include_control, tag)
end

new_mt.__call = ThermostatScheduleTransition.init
new_mt.__index.serialize = ThermostatScheduleTransition.serialize

ThermostatScheduleTransition.augment_type = function(self, val)
  local elems = {}
...
setmetatable(ThermostatScheduleTransition, new_mt)
