...
--- @field public NAME string "ConfigStatus" the name of this attribute
...
ConfigStatus.enum_fields = {
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint8 the base data type object to add functionality to
function ConfigStatus:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function ConfigStatus.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, ConfigStatus.enum_fields[value_obj.value])
end
...
function ConfigStatus:new_value(...)
...
function ConfigStatus:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function ConfigStatus:subscribe(device, endpoint_id)
...
function ConfigStatus:set_parent_cluster(cluster)
...
function ConfigStatus:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function ConfigStatus:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(ConfigStatus, {__call = ConfigStatus.new_value})
return ConfigStatus
