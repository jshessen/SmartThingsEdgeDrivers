...
function CurrentPositionLift:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentPositionLift:subscribe(device, endpoint_id)
...
function CurrentPositionLift:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentPositionLift:deserialize(tlv_buf)
