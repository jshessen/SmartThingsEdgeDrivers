...
function CurrentPositionLiftPercentage:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentPositionLiftPercentage:subscribe(device, endpoint_id)
...
function CurrentPositionLiftPercentage:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentPositionLiftPercentage:deserialize(tlv_buf)
