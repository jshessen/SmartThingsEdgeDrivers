...
function CurrentPositionTilt:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentPositionTilt:subscribe(device, endpoint_id)
...
function CurrentPositionTilt:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentPositionTilt:deserialize(tlv_buf)
