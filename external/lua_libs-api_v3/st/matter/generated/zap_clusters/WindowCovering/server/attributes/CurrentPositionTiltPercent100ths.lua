...
--- @alias CurrentPositionTiltPercent100ths
---
--- @field public ID number 0x000F the ID of this attribute
--- @field public NAME string "CurrentPositionTiltPercent100ths" the name of this attribute
--- @field public data_type st.matter.data_types.Uint16 the data type of this attribute

local CurrentPositionTiltPercent100ths = {
  ID = 0x000F,
...
function CurrentPositionTiltPercent100ths:new_value(...)
...
function CurrentPositionTiltPercent100ths:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentPositionTiltPercent100ths:subscribe(device, endpoint_id)
...
function CurrentPositionTiltPercent100ths:set_parent_cluster(cluster)
...
function CurrentPositionTiltPercent100ths:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentPositionTiltPercent100ths:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(CurrentPositionTiltPercent100ths, {__call = CurrentPositionTiltPercent100ths.new_value})
