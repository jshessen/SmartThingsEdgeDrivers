...
function CurrentPositionTiltPercentage:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function CurrentPositionTiltPercentage:subscribe(device, endpoint_id)
...
function CurrentPositionTiltPercentage:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function CurrentPositionTiltPercentage:deserialize(tlv_buf)
