...
function InstalledClosedLimitLift:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function InstalledClosedLimitLift:subscribe(device, endpoint_id)
...
function InstalledClosedLimitLift:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function InstalledClosedLimitLift:deserialize(tlv_buf)
