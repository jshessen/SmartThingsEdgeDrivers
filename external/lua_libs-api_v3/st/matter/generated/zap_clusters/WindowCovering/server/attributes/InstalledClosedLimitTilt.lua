...
function InstalledClosedLimitTilt:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function InstalledClosedLimitTilt:subscribe(device, endpoint_id)
...
function InstalledClosedLimitTilt:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function InstalledClosedLimitTilt:deserialize(tlv_buf)
