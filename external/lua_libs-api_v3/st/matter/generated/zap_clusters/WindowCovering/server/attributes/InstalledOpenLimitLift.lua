...
function InstalledOpenLimitLift:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function InstalledOpenLimitLift:subscribe(device, endpoint_id)
...
function InstalledOpenLimitLift:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function InstalledOpenLimitLift:deserialize(tlv_buf)
