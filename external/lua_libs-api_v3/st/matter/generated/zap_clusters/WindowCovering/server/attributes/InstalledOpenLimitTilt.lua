...
function InstalledOpenLimitTilt:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function InstalledOpenLimitTilt:subscribe(device, endpoint_id)
...
function InstalledOpenLimitTilt:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function InstalledOpenLimitTilt:deserialize(tlv_buf)
