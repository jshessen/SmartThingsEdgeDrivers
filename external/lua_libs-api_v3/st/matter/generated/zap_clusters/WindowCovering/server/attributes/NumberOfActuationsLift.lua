...
function NumberOfActuationsLift:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfActuationsLift:subscribe(device, endpoint_id)
...
function NumberOfActuationsLift:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfActuationsLift:deserialize(tlv_buf)
