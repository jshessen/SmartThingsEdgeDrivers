...
function NumberOfActuationsTilt:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function NumberOfActuationsTilt:subscribe(device, endpoint_id)
...
function NumberOfActuationsTilt:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function NumberOfActuationsTilt:deserialize(tlv_buf)
