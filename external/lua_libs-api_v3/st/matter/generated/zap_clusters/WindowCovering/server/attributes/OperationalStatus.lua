...
--- @field public NAME string "OperationalStatus" the name of this attribute
...
OperationalStatus.enum_fields = {
}

--- Add additional functionality to the base type object
---
--- @param base_type_obj st.matter.data_types.Uint8 the base data type object to add functionality to
function OperationalStatus:augment_type(base_type_obj)
  base_type_obj.field_name = self.NAME
  base_type_obj.pretty_print = self.pretty_print
end

function OperationalStatus.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, OperationalStatus.enum_fields[value_obj.value])
end
...
function OperationalStatus:new_value(...)
...
function OperationalStatus:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function OperationalStatus:subscribe(device, endpoint_id)
...
function OperationalStatus:set_parent_cluster(cluster)
...
function OperationalStatus:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function OperationalStatus:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  self:augment_type(data)
  return data
end

setmetatable(OperationalStatus, {__call = OperationalStatus.new_value})
