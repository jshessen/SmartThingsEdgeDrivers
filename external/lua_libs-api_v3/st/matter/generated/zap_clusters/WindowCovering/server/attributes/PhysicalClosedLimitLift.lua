...
function PhysicalClosedLimitLift:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PhysicalClosedLimitLift:subscribe(device, endpoint_id)
...
function PhysicalClosedLimitLift:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PhysicalClosedLimitLift:deserialize(tlv_buf)
