...
function PhysicalClosedLimitTilt:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function PhysicalClosedLimitTilt:subscribe(device, endpoint_id)
...
function PhysicalClosedLimitTilt:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function PhysicalClosedLimitTilt:deserialize(tlv_buf)
