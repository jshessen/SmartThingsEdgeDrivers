...
function SafetyStatus.pretty_print(value_obj)
  return string.format("%s.%s", value_obj.field_name or value_obj.NAME, SafetyStatus.enum_fields[value_obj.value])
end
...
function SafetyStatus:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function SafetyStatus:subscribe(device, endpoint_id)
...
function SafetyStatus:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function SafetyStatus:deserialize(tlv_buf)
