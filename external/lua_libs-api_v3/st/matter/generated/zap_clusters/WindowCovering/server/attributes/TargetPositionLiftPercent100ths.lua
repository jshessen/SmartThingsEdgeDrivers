...
--- @alias TargetPositionLiftPercent100ths
---
--- @field public ID number 0x000B the ID of this attribute
--- @field public NAME string "TargetPositionLiftPercent100ths" the name of this attribute
--- @field public data_type st.matter.data_types.Uint16 the data type of this attribute

local TargetPositionLiftPercent100ths = {
  ID = 0x000B,
...
function TargetPositionLiftPercent100ths:new_value(...)
...
function TargetPositionLiftPercent100ths:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function TargetPositionLiftPercent100ths:subscribe(device, endpoint_id)
...
function TargetPositionLiftPercent100ths:set_parent_cluster(cluster)
...
function TargetPositionLiftPercent100ths:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function TargetPositionLiftPercent100ths:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(TargetPositionLiftPercent100ths, {__call = TargetPositionLiftPercent100ths.new_value})
