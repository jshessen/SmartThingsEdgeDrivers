...
--- @alias TargetPositionTiltPercent100ths
---
--- @field public ID number 0x000C the ID of this attribute
--- @field public NAME string "TargetPositionTiltPercent100ths" the name of this attribute
--- @field public data_type st.matter.data_types.Uint16 the data type of this attribute

local TargetPositionTiltPercent100ths = {
  ID = 0x000C,
...
function TargetPositionTiltPercent100ths:new_value(...)
...
function TargetPositionTiltPercent100ths:read(device, endpoint_id)
...
--- @param endpoint_id number|nil
--- @return any
function TargetPositionTiltPercent100ths:subscribe(device, endpoint_id)
...
function TargetPositionTiltPercent100ths:set_parent_cluster(cluster)
...
function TargetPositionTiltPercent100ths:build_test_report_data(
  device,
  endpoint_id,
  value,
  status
...
function TargetPositionTiltPercent100ths:deserialize(tlv_buf)
  local data = TLVParser.decode_tlv(tlv_buf)
  
  return data
end

setmetatable(TargetPositionTiltPercent100ths, {__call = TargetPositionTiltPercent100ths.new_value})
