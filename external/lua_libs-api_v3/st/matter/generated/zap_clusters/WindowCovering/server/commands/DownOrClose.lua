...
DownOrClose.ID = 0x0001
DownOrClose.field_defs = {
}
...
function DownOrClose:build_test_command_response(device, endpoint_id, status)
...
function DownOrClose:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function DownOrClose:augment_type(base_type_obj)
  local elems = {}
...
function DownOrClose:deserialize(tlv_buf)
