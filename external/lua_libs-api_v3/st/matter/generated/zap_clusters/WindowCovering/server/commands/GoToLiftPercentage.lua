...
--- @field public lift_percent100ths_value data_types.Uint16
local GoToLiftPercentage = {}

GoToLiftPercentage.NAME = "GoToLiftPercentage"
GoToLiftPercentage.ID = 0x0005
GoToLiftPercentage.field_defs = {
  {
    name = "lift_percent100ths_value",
    field_id = 0,
    optional = false,
    nullable = false,
...
function GoToLiftPercentage:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param lift_percent100ths_value st.matter.data_types.Uint16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function GoToLiftPercentage:init(device, endpoint_id, lift_percent100ths_value)
  local out = {}
  local args = {lift_percent100ths_value}
...
function GoToLiftPercentage:augment_type(base_type_obj)
  local elems = {}
...
function GoToLiftPercentage:deserialize(tlv_buf)
