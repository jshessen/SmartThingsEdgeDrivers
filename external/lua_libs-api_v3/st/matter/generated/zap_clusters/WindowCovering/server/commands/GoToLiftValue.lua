...
--- @field public lift_value data_types.Uint16
local GoToLiftValue = {}

GoToLiftValue.NAME = "GoToLiftValue"
GoToLiftValue.ID = 0x0004
GoToLiftValue.field_defs = {
  {
    name = "lift_value",
    field_id = 0,
    optional = false,
...
function GoToLiftValue:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param lift_value st.matter.data_types.Uint16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function GoToLiftValue:init(device, endpoint_id, lift_value)
  local out = {}
...
function GoToLiftValue:augment_type(base_type_obj)
  local elems = {}
...
function GoToLiftValue:deserialize(tlv_buf)
