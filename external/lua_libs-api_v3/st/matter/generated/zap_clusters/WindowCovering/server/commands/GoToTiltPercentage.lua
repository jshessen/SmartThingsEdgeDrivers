...
--- @field public tilt_percent100ths_value data_types.Uint16
local GoToTiltPercentage = {}

GoToTiltPercentage.NAME = "GoToTiltPercentage"
GoToTiltPercentage.ID = 0x0008
GoToTiltPercentage.field_defs = {
  {
    name = "tilt_percent100ths_value",
    field_id = 0,
    optional = false,
    nullable = false,
...
function GoToTiltPercentage:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param tilt_percent100ths_value st.matter.data_types.Uint16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function GoToTiltPercentage:init(device, endpoint_id, tilt_percent100ths_value)
  local out = {}
  local args = {tilt_percent100ths_value}
...
function GoToTiltPercentage:augment_type(base_type_obj)
  local elems = {}
...
function GoToTiltPercentage:deserialize(tlv_buf)
