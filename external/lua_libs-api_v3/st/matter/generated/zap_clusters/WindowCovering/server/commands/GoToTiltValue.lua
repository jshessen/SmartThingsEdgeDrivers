...
--- @field public tilt_value data_types.Uint16
local GoToTiltValue = {}

GoToTiltValue.NAME = "GoToTiltValue"
GoToTiltValue.ID = 0x0007
GoToTiltValue.field_defs = {
  {
    name = "tilt_value",
    field_id = 0,
    optional = false,
...
function GoToTiltValue:build_test_command_response(device, endpoint_id, status)
...
--- @param device st.matter.Device the device to build this message to
--- @param tilt_value st.matter.data_types.Uint16

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function GoToTiltValue:init(device, endpoint_id, tilt_value)
  local out = {}
...
function GoToTiltValue:augment_type(base_type_obj)
  local elems = {}
...
function GoToTiltValue:deserialize(tlv_buf)
