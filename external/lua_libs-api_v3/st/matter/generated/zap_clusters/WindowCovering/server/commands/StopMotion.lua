...
-----------------------------------------------------------
-- WindowCovering command StopMotion
-----------------------------------------------------------
...
--- @field public NAME string "StopMotion" the name of this command
local StopMotion = {}

StopMotion.NAME = "StopMotion"
StopMotion.ID = 0x0002
StopMotion.field_defs = {
}
...
function StopMotion:build_test_command_response(device, endpoint_id, status)
...
---
--- @param self StopMotion the template class for this command
--- @param device st.matter.Device the device to build this message to

--- @return st.matter.interaction_model.InteractionRequest of type INVOKE
function StopMotion:init(device, endpoint_id)
  local out = {}
  local args = {}
  ...
  setmetatable(out, {
    __index = StopMotion,
    __tostring = StopMotion.pretty_print
  })
...
function StopMotion:set_parent_cluster(cluster)
...
function StopMotion:augment_type(base_type_obj)
  local elems = {}
...
function StopMotion:deserialize(tlv_buf)
  return TLVParser.decode_tlv(tlv_buf)
end

setmetatable(StopMotion, {__call = StopMotion.init})
