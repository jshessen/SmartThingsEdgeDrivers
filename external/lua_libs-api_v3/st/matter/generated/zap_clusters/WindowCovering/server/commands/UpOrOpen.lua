...
function UpOrOpen:build_test_command_response(device, endpoint_id, status)
...
function UpOrOpen:init(device, endpoint_id)
  local out = {}
  local args = {}
...
function UpOrOpen:augment_type(base_type_obj)
  local elems = {}
...
function UpOrOpen:deserialize(tlv_buf)
