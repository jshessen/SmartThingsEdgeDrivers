...
--- see the ZCL spec for further details
---
...
function FloatABC.new_mt(base, byte_length, mantissa_bit_length, exponent_bit_length)
  ...
  i_table.pretty_print = function(self)
    if self.sign_bit == nil or self.mantissa == nil or self.exponent == nil then
  ...
  mt.__newindex = function(self, k, v)
    ...
    elseif k == "value" then
      error("You cannot directly set the value of a Float, set the components instead (sign, mantissa, exponent)")
    end
    rawset(self, k, v)
  end
